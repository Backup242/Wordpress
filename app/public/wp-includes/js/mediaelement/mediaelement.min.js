...
})(
  {
            ...
            if ("string" == typeof e && e.length) {
              ...
              return (
                void 0 !== d[a] &&
                  ...
                  null !== t &&
                    "number" == typeof t &&
                    ((r = d[a]["mejs.plural-form"]),
                    (n = i.apply(null, [n, t, r])))),
                !n &&
                  d.en &&
                  ((n = d.en[e]),
                  null !== t &&
      ...
      function (e, t, n) {
        ...
        var a = function e(t, n, r) {
          ...
          (f.mediaElement.options = n),
            (a = a || "mejs_" + Math.random().toString().slice(2)),
              ...
              if (
                ...
                (n.onreadystatechange = function () {
                  if (4 === this.readyState && 200 === this.status) {
                    var e = (
                      O.default.URL || O.default.webkitURL
    ...
    7: [
      function (e, t, n) {
        ...
        (((r = a) && r.__esModule ? r : { default: r }).default.mejs = i),
          (n.default = i);
      },
      { 3: 3 },
    ],
              ...
              return (
                "undefined" != typeof dashjs
                  ...
                  : ((e.options.path =
                    ...
                    (j.promise =
                      j.promise || (0, i.loadScript)(e.options.path)),
            ...
            create: function (l, s, e) {
                  ...
                  p = function (a) {
                    ...
                    (d["get" + e] = function () {
                      ...
                      (d["set" + e] = function (e) {
                        if (
                          -1 ===
                          _.default.html5media.readOnlyProperties.indexOf(a)
                        )
                          if ("src" === a) {
                            var t =
                              "object" ===
              ...
              if (
                ((w.default["__ready__" + i] = function (e) {
                  l.dashPlayer = u = e;
                  for (
                    var t, n = dashjs.MediaPlayer.events, r = 0, a = f.length;
                    r < a;
                    r++
                  )
              ...
              return (
                l.dispatchEvent(E),
                l.promises.push(j.load({ options: s.dash, id: i })),
                d
              );
            },
          };
                ...
                i[e] = function () {
                  if (r)
                    if (null !== i.flashApi) {
                      ...
                      i.flashApiStack.push({ type: "call", methodName: e });
                };
              };
            d.push("stop");
              ...
              return (
                "undefined" != typeof flvjs
                  ...
                  : ((e.options.path =
                    ...
                    (S.promise =
                      S.promise || (0, i.loadScript)(e.options.path)),
                  ...
                  r = function (i) {
                    ...
                    (d["get" + e] = function () {
                      ...
                      (d["set" + e] = function (e) {
                        if (
                          -1 ===
                          b.default.html5media.readOnlyProperties.indexOf(i)
                        )
                          if ("src" === i) {
                            if (
                              ((d[i] =
          ...
          l = {
            ...
            create: function (d, a, u) {
              var e = d.originalNode,
                ...
                p = u.length;
              (f = e.cloneNode(!0)),
                ((a = Object.assign(a, d.options)).hls.autoStartLoad =
                  (t && "none" !== t) || n);
              for (
              ...
              return (
                d.dispatchEvent(g),
                d.promises.push(S.load({ options: a.hls, id: i })),
                f
              );
            },
          };
      ...
      function (e, t, n) {
        ...
        var T = {
            ...
            loadIframeApi: function () {
              T.isIframeStarted ||
                ((0, i.loadScript)("https://www.youtube.com/player_api"),
                (T.isIframeStarted = !0));
            },
            ...
            getYouTubeIdFromParam: function (e) {
              ...
              for (
                var t = e.split("?")[1].split("&"), n = "", r = 0, a = t.length;
                r < a;
                r++
              ) {
                var i = t[r].split("=");
      ...
      function (e, t, n) {
        ...
        for (
          var l = (n.NAV = a.default.navigator),
            ...
            p = (n.IS_EDGE =
              ("msLaunchUri" in l) && !("documentMode" in i.default)),
    ...
    19: [
      function (e, t, n) {
        ...
        function c(e) {
          ...
          return (
            a &&
              (~["mp4", "m4v", "ogg", "ogv", "webm", "flv", "mpeg"].indexOf(a)
                ? (i = "video/" + a)
                : "mov" === a
                ? (i = "video/quicktime")
