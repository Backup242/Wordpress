  ...
  return u.widget("ui.selectmenu", [
    u.ui.formResetMixin,
    {
            ...
            .menu({
              ...
              focus: function (e, t) {
                ...
                null != i.focusIndex &&
                  ...
                  (i._trigger("focus", e, { item: t }),
                  i.isOpen || i._select(t, e)),
                  (i.focusIndex = t.index),
                  i.button.attr(
                    "aria-activedescendant",
                    i.menuItems.eq(t.index).attr("id")
                  );
              },
            })
            .menu("instance")),
      ...
      _renderButtonItem: function (e) {
        var t = u("<span>");
        return (
          this._setText(t, e.label), this._addClass(t, "ui-selectmenu-text"), t
        );
      },
        ...
        this.isOpen
          ...
          (i =
            "first" === e || "last" === e
              ...
              : i[e + "All"](n).eq(0)).length && this.menuInstance.focus(t, i);
      },
      ...
      _documentClick: {
        mousedown: function (e) {
          !this.isOpen ||
            u(e.target).closest(
              ".ui-selectmenu-menu, #" + u.escapeSelector(this.ids.button)
            ).length ||
            this.close(e);
        },
      },
      ...
      _parseOptions: function (e) {
        var i = this,
          n = [];
        e.each(function (e, t) {
          t.hidden || n.push(i._parseOption(u(t), e));
        }),
          (this.items = n);
      },
