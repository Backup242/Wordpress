  ...
  r.widget("ui.controlgroup", {
            ...
            : r.fn[n] &&
              ...
              s.element.find(t).each(function () {
                var t = r(this),
                  e = t[n]("instance"),
                  i = r.widget.extend({}, o);
                ("button" === n && t.parent(".ui-spinner").length) ||
                  ((e = e || t[n]()[n]("instance")) &&
                    (i.classes = s._resolveClassesValues(i.classes, e)),
                  t[n](i),
                  (i = t[n]("widget")),
    ...
    refresh: function () {
      ...
      this._addClass(
        ...
        this._initWidgets(),
        (o = this.childWidgets),
        (o = this.options.onlyVisible ? o.filter(":visible") : o).length &&
          (r.each(["first", "last"], function (t, e) {
            ...
            n && s["_" + n.widgetName + "Options"]
              ? (((i = s["_" + n.widgetName + "Options"](
                  1 === o.length ? "only" : e
                )).classes = s._resolveClassesValues(i.classes, n)),
