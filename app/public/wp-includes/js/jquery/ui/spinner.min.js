...
!(function (t) {
  ...
  return (
    u.widget("ui.spinner", {
      ...
      _getCreateOptions: function () {
        var e = this._super(),
          s = this.element;
        return (
          u.each(["min", "max", "step"], function (t, i) {
            var n = s.attr(i);
      ...
      _events: {
        ...
        mousewheel: function (t, i) {
          var n = u.ui.safeActiveElement(this.document[0]);
        ...
        "mousedown .ui-spinner-button": function (t) {
          ...
          (i =
            ...
            !1 !== this._start(t) &&
              this._repeat(
                null,
                u(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1,
                t
              );
        },
        "mouseup .ui-spinner-button": "_stop",
        "mouseenter .ui-spinner-button": function (t) {
          if (u(t.currentTarget).hasClass("ui-state-active"))
            return (
              !1 !== this._start(t) &&
              void this._repeat(
                null,
    ...
    !1 !== u.uiBackCompat &&
      u.widget("ui.spinner", u.ui.spinner, {
        _enhance: function () {
          this.uiSpinner = this.element
            .attr("autocomplete", "off")
