  ...
  return (
            ...
            (this.element
              ...
              .each(function () {
                ...
                if (
                  ...
                  a.ui.intersect(
                    i,
                    a.extend(e, { offset: e.element.offset() }),
                    e.options.tolerance,
                    t
                  )
                )
    ...
    (a.ui.intersect = function (e, t, i, s) {
      ...
      switch (i) {
        ...
        case "touch":
          return (
            ((p <= r && r <= d) || (p <= a && a <= d) || (r < p && d < a)) &&
            ((l <= o && o <= c) || (l <= n && n <= c) || (o < l && c < n))
          );
        default:
          return !1;
      }
    ...
    !(a.ui.ddmanager = {
        ...
        e: for (i = 0; i < o.length; i++)
          if (
            !(
              ...
              (e &&
                !o[i].accept.call(o[i].element[0], e.currentItem || e.element))
            )
          ) {
      ...
      drop: function (e, t) {
        ...
        return (
          a.each(
            (a.ui.ddmanager.droppables[e.options.scope] || []).slice(),
            function () {
              this.options &&
                (!this.options.disabled &&
                  this.visible &&
                  a.ui.intersect(e, this, this.options.tolerance, t) &&
        ...
        o.options.refreshPositions && a.ui.ddmanager.prepareOffsets(o, r),
          a.each(a.ui.ddmanager.droppables[o.options.scope] || [], function () {
            ...
            this.options.disabled ||
              ...
              !this.visible ||
              ((s =
                !(s = a.ui.intersect(o, this, this.options.tolerance, r)) &&
                this.isover
                  ? "isout"
                  : s && !this.isover
                  ? "isover"
                ...
                (this.options.greedy &&
                  ...
                  ((e = a(i[0]).droppable("instance")).greedyChild =
                    "isover" === s),
                e &&
                  "isover" === s &&
                  ((e.isover = !1), (e.isout = !0), e._out.call(e, r)),
                (this[s] = !0),
                (this["isout" === s ? "isover" : "isout"] = !1),
                this["isover" === s ? "_over" : "_out"].call(this, r),
                e) &&
                "isout" === s &&
                ((e.isout = !1), (e.isover = !0), e._over.call(e, r)));
          });
      },
