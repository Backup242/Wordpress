      ...
      _addDescribedBy: function (t, i) {
        ...
        e.push(i),
          t
            ...
            .attr("aria-describedby", String.prototype.trim.call(e.join(" ")));
      },
          ...
          t &&
            ...
            i.parents().each(function () {
              ...
              i.data("ui-tooltip-open") &&
                (((t = r.Event("blur")).target = t.currentTarget = this),
                e.close(t, !0)),
                i.attr("title") &&
                  (i.uniqueId(),
                  (e.parents[this.id] = {
        ...
        e &&
          ((s = this._find(i))
            ...
            : (i.is("[title]") &&
              ...
              (s = r("<div>").html(o.find(".ui-tooltip-content").html()))
                .removeAttr("name")
                .find("[name]")
                .removeAttr("name"),
              ...
              this.options.track && t && /^mouse/.test(t.type)
                ...
                : o.position(r.extend({ of: i }, this.options.position)),
              o.hide(),
        ...
        var e = {
          keyup: function (t) {
            t.keyCode === r.ui.keyCode.ESCAPE &&
              (((t = r.Event(t)).currentTarget = i[0]), this.close(t, !0));
          },
        };
        i[0] !== this.element[0] &&
          (e.remove = function () {
