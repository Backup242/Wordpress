    ...
    z.widget("ui.resizable", z.ui.mouse, {
      ...
      _renderProxy: function () {
        ...
        (this.elementOffset = t.offset()),
          this._helper
            ? ((this.helper =
                this.helper || z("<div></div>").css({ overflow: "hidden" })),
    ...
    z.ui.plugin.add("resizable", "animate", {
      stop: function (i) {
        var e = z(this).resizable("instance"),
          ...
          h = { width: e.size.width - h, height: e.size.height - n },
          n =
        ...
        e.element.animate(z.extend(h, o && n ? { top: o, left: n } : {}), {
    ...
    z.ui.plugin.add("resizable", "containment", {
      ...
      resize: function (t) {
        ...
        o[0] !== document && /static/.test(o.css("position")) && (n = s),
          ...
          (h = Math.abs(
            i.sizeDiff.width +
              (i._helper ? i.offset.left - n.left : i.offset.left - s.left)
          )),
          (o = Math.abs(
            i.sizeDiff.height +
              (i._helper ? i.offset.top - n.top : i.offset.top - s.top)
          )),
          h + i.size.width >= i.parentData.width &&
            ((i.size.width = i.parentData.width - h), t) &&
            ((i.size.height = i.size.width / i.aspectRatio), (a = !1)),
          o + i.size.height >= i.parentData.height &&
            ((i.size.height = i.parentData.height - o), t) &&
            ((i.size.width = i.size.height * i.aspectRatio), (a = !1)),
          a ||
        ...
        (e.grid = a),
          ...
          /^(se|s|e)$/.test(o)
            ...
            : ((g - r <= 0 || d - l <= 0) &&
              ...
              0 < g - r
                ? ((i.size.height = g), (i.position.top = n.top - s))
                : ((g = r - t.height),
                  (i.size.height = g),
                  (i.position.top = n.top + h.height - g)),
              0 < d - l
                ? ((i.size.width = d), (i.position.left = n.left - p))
                : ((d = l - t.width),
                  (i.size.width = d),
