  ...
  return (
    l.widget("ui.dialog", {
      ...
      close: function (i) {
        ...
        this._isOpen &&
          ...
          this.opener.filter(":focusable").trigger("focus").length ||
            l.ui.safeBlur(l.ui.safeActiveElement(this.document[0])),
      ...
      _focusTabbable: function () {
        ...
        (i = (i = (i = (i = (i = i || this.element.find("[autofocus]")).length
          ? i
            ...
            keydown: function (i) {
              ...
              i.keyCode === l.ui.keyCode.ESCAPE
                ...
                : i.keyCode !== l.ui.keyCode.TAB ||
                  i.isDefaultPrevented() ||
                  ((t = this.uiDialog.find(":tabbable")),
                  (e = t.first()),
                  (o = t.last()),
                  (i.target !== o[0] && i.target !== this.uiDialog[0]) ||
                  i.shiftKey
      ...
      _createTitlebar: function () {
        ...
        (this.uiDialogTitlebar = l("<div>")),
          ...
          this._on(this.uiDialogTitlebar, {
            mousedown: function (i) {
              l(i.target).closest(".ui-dialog-titlebar-close") ||
                this.uiDialog.trigger("focus");
            },
          }),
          (this.uiDialogTitlebarClose = l("<button type='button'></button>")
            .button({
        ...
        this.uiDialogButtonPane.remove(),
          ...
          l.isEmptyObject(i) || (Array.isArray(i) && !i.length)
            ...
            : (l.each(i, function (i, t) {
                ...
                (t = l.extend(
                  { type: "button" },
                  (t = "function" == typeof t ? { click: t, text: i } : t)
                )),
                  (e = t.click),
                  (i = {
                    icon: t.icon,
      ...
      _setOption: function (i, t) {
        ...
        "disabled" !== i &&
          ...
          "draggable" === i &&
            ((e = o.is(":data(ui-draggable)")) && !t && o.draggable("destroy"),
            !e) &&
            t &&
            this._makeDraggable(),
          "position" === i && this._position(),
          "resizable" === i &&
            ((e = o.is(":data(ui-resizable)")) && !t && o.resizable("destroy"),
          ...
          this.document.data("ui-dialog-overlays") ||
            this.document.on(
              ...
              function (i) {
                var t;
                o ||
                  (t = this._trackingInstances()[0])._allowInteraction(i) ||
                  (i.preventDefault(),
                  t._focusTabbable(),
                  "3.4." !== e && "3.5." !== e) ||
