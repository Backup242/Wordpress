      ...
      if (this.length) {
        var E,
          ...
          e =
            ("function" == typeof F
              ? (F = { success: F })
              : "string" == typeof F || (!1 === F && 0 < arguments.length)
              ? ((F = { url: F, data: e, dataType: t }),
                "function" == typeof a && (F.success = a))
              : void 0 === F && (F = {}),
            (E = F.method || F.type || this.attr2("method")),
            (t =
              (t =
                (t =
                  "string" == typeof (e = F.url || this.attr2("action"))
                    ? O.trim(e)
                    : "") ||
            ...
            {});
        if ((this.trigger("form-pre-serialize", [this, F, e]), e.veto))
          C("ajaxSubmit: submit vetoed via form-pre-serialize trigger");
        else if (F.beforeSerialize && !1 === F.beforeSerialize(this, F))
          ...
          if (
            (F.data &&
              ((a = O.isFunction(F.data) ? F.data(r) : F.data),
              (F.extraData = a),
              (l = O.param(a, t))),
            F.beforeSubmit && !1 === F.beforeSubmit(r, this, F))
          )
            C("ajaxSubmit: submit aborted via beforeSubmit callback");
          else if (
            (this.trigger("form-submit-validate", [r, this, F, e]), e.veto)
          )
            ...
            F.resetForm &&
              ...
              (F.success = function (e, t, a) {
                for (var r = F.context || this, n = 0, o = s.length; n < o; n++)
            ...
            var c,
              e =
                0 <
                O("input[type=file]:enabled", this).filter(function () {
                  return "" !== O(this).val();
                }).length,
            ...
            C("fileAPI :" + a),
              !1 !== F.iframe && (F.iframe || ((e || l) && !a))
                ? F.closeKeepAlive
                  ? O.get(F.closeKeepAlive, function () {
                      c = f(r);
                    })
                  : (c = f(r))
                : (c =
                    (e || l) && a
                      ? (function (e) {
                          for (var a = new FormData(), t = 0; t < e.length; t++)
                            a.append(e[t].name, e[t].value);
                          if (F.extraData) {
                            var r = (function (e) {
                              var t,
                                a,
                          ...
                          return (
                            (n.beforeSend = function (e, t) {
                              F.formData ? (t.data = F.formData) : (t.data = a),
                                o && o.call(this, e, t);
                            }),
                            O.ajax(n)
                          );
      ...
      function f(e) {
        ...
        return (
          ...
          (m = {
            ...
            abort: function (e) {
              ...
              f.attr("src", l.iframeSrc),
                ...
                u && O.event.trigger("ajaxError", [m, l, t]),
                l.complete && l.complete.call(l.context, m, t);
            },
          }),
          (u = l.global) && 0 == O.active++ && O.event.trigger("ajaxStart"),
          ...
          l.beforeSend && !1 === l.beforeSend.call(l.context, m, l)
            ...
            : ((e = o.clk) &&
              ...
              (v = 1),
              (x = 2),
              (e = O("meta[name=csrf-token]").attr("content")),
              (r = O("meta[name=csrf-param]").attr("content")) &&
                e &&
                ((l.extraData = l.extraData || {}), (l.extraData[r] = e)),
              ...
              (S = function (e, t, a) {
                ...
                return (
                  n &&
                    ...
                    O.error("parsererror"),
                  "string" ==
                    typeof (e = a && a.dataFilter ? a.dataFilter(e, t) : e) &&
                    (("json" === t || !t) && 0 <= r.indexOf("json")
                      ? (e = i(e))
                      : ("script" === t || !t) &&
        ...
        function n() {
          var e = L.attr2("target"),
            t = L.attr2("action"),
            a =
              L.attr("enctype") || L.attr("encoding") || "multipart/form-data";
          o.setAttribute("target", s),
            (E && !/post/i.test(E)) || o.setAttribute("method", "POST"),
          ...
          try {
            ...
            o.setAttribute("action", t),
              ...
              e ? o.setAttribute("target", e) : L.removeAttr("target"),
              O(r).remove();
          }
        }
        function A(t) {
          if (!m.aborted && !j)
            if (
              ((b = D(d)) || (C("cannot access response document"), (t = x)),
              t === v && m)
            )
              m.abort("timeout"), g.reject(m, "timeout");
            else if (t === x && m)
              m.abort("server abort"), g.reject(m, "error", "server abort");
            else if ((b && b.location.href !== l.iframeSrc) || p) {
              d.detachEvent
              ...
              try {
                ...
                var r,
                  ...
                  s =
                    ((m.responseText = i ? i.innerHTML : null),
                    (m.responseXML = b.XMLDocument || b),
                    e && (l.dataType = "xml"),
                    ...
                    i &&
                      ...
                      (m.statusText =
                        i.getAttribute("statusText") || m.statusText)),
                    (l.dataType || "").toLowerCase()),
                  c = /(json|script|text)/.test(s);
                c || l.textarea
                  ? (r = b.getElementsByTagName("textarea")[0])
                    ? ((m.responseText = r.value),
                      (m.status = Number(r.getAttribute("status")) || m.status),
                      (m.statusText =
                        r.getAttribute("statusText") || m.statusText))
                    : c &&
                      ((n = b.getElementsByTagName("pre")[0]),
                      (o = b.getElementsByTagName("body")[0]),
                      n
                        ? (m.responseText = n.textContent || n.innerText)
                        : o && (m.responseText = o.textContent || o.innerText))
                  : "xml" === s &&
                    !m.responseXML &&
                    m.responseText &&
                    (m.responseXML = w(m.responseText));
                try {
                  y = S(m, s, l);
                } catch (e) {
              ...
              m.aborted && (C("upload aborted"), (t = null)),
                "success" ===
                (t = m.status
                  ? (200 <= m.status && m.status < 300) || 304 === m.status
                    ? "success"
                    : "error"
                  : t)
                  ? (l.success && l.success.call(l.context, y, "success", m),
                    g.resolve(m.responseText, "success", m),
                    u && O.event.trigger("ajaxSuccess", [m, l]))
                  : t &&
                    (void 0 === a && (a = m.statusText),
                    l.error && l.error.call(l.context, m, t, a),
                    g.reject(m, "error", a),
                    u) &&
                    O.event.trigger("ajaxError", [m, l, a]),
                u && O.event.trigger("ajaxComplete", [m, l]),
                u && !--O.active && O.event.trigger("ajaxStop"),
                l.complete && l.complete.call(l.context, m, t),
                (j = !0),
                l.timeout && clearTimeout(h),
                setTimeout(function () {
                  l.iframeTarget ? f.attr("src", l.iframeSrc) : f.remove(),
                    (m.responseXML = null);
                }, 100);
            }
        }
    ...
    (O.fn.ajaxForm = function (e, t, a, r) {
      ...
      return (
        ("string" == typeof e || (!1 === e && 0 < arguments.length)) &&
          ((e = { url: e, data: t, dataType: a }), "function" == typeof r) &&
          (e.success = r),
        ((e = e || {}).delegation = e.delegation && O.isFunction(O.fn.on)),
        ...
        if (
          ...
          for (
            var s,
              ...
              f,
              d = 0,
              m = (i = O.isFunction(a) ? O.map(i, a) : i).length;
            d < m;
            d++
          )
            if ((f = (l = i[d]).name) && !l.disabled)
              if (e && n.clk && "image" === l.type)
                n.clk === l &&
                  (r.push({ name: f, value: O(l).val(), type: l.type }),
                  r.push(
                    { name: f + ".x", value: n.clk_x },
                    { name: f + ".y", value: n.clk_y }
                  ));
              else if ((c = O.fieldValue(l, !0)) && c.constructor === Array)
                for (t && t.push(l), s = 0, u = c.length; s < u; s++)
                ...
                if (p.length)
                  for (s = 0; s < p.length; s++)
                    r.push({ name: f, value: p[s], type: l.type });
                else r.push({ name: f, value: "", type: l.type });
              } else
                null != c &&
                  (t && t.push(l),
                  r.push({
    ...
    (O.fieldValue = function (e, t) {
      ...
      if (
        ...
        (!a ||
          ...
          (("submit" === r || "image" === r) && e.form && e.form.clk !== e) ||
      ...
      for (
        ...
        if (u.selected && !u.disabled) {
          var f =
            (f = u.value) ||
            (u.attributes && u.attributes.value && !u.attributes.value.specified
              ? u.text
              : u.value);
          if (s) return f;
          o.push(f);
