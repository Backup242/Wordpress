/******/ (function () {
  ...
  __webpack_require__.d(__webpack_exports__, {
    ...
    PAGEDOWN: function () {
      return /* binding */ PAGEDOWN;
    },
    PAGEUP: function () {
      return /* binding */ PAGEUP;
    },
    RIGHT: function () {
    ...
    displayShortcut: function () {
      return /* binding */ displayShortcut;
    },
    displayShortcutList: function () {
      return /* binding */ displayShortcutList;
    },
    isAppleOS: function () {
      return /* reexport */ isAppleOS;
    },
    isKeyboardEvent: function () {
      return /* binding */ isKeyboardEvent;
    },
    modifiers: function () {
      return /* binding */ modifiers;
    },
    rawShortcut: function () {
      return /* binding */ rawShortcut;
    },
    shortcutAriaLabel: function () {
      return /* binding */ shortcutAriaLabel;
    },
...
***************************************************************************** */
  ...
  var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/@wordpress/keycodes/build-module/platform.js
  /**
          ...
          const modifierKeys = modifier(_isApple).reduce(
            (accumulator, key) => {
              ...
              const replacementKey =
                (_replacementKeyMap$ke = replacementKeyMap[key]) !== null &&
                _replacementKeyMap$ke !== void 0
                  ? _replacementKeyMap$ke
                  : key; // If on the Mac, adhere to platform convention and don't show plus between keys.
  ...
  const shortcutAriaLabel = mapValues(
    modifiers,
    (
      /** @type {WPModifier} */
      modifier
        ...
        function (character) {
          ...
          return [...modifier(_isApple), character]
            .map((key) => {
              ...
              return capitalCase(
                (_replacementKeyMap$ke2 = replacementKeyMap[key]) !== null &&
                  _replacementKeyMap$ke2 !== void 0
                  ? _replacementKeyMap$ke2
                  : key
              );
            })
            .join(isApple ? " " : " + ");
  ...
  const isKeyboardEvent = mapValues(
    modifiers,
    (
      /** @type {WPModifier} */
      getModifiers
