/******/ (function () {
  ...
  !(function () {
    ...
    __webpack_require__.d(__webpack_exports__, {
      ...
      createI18n: function () {
        return /* reexport */ createI18n;
      },
      defaultI18n: function () {
        return /* reexport */ default_i18n;
      },
      getLocaleData: function () {
        return /* reexport */ getLocaleData;
      },
      hasTranslation: function () {
        return /* reexport */ hasTranslation;
      },
      isRTL: function () {
        return /* reexport */ isRTL;
      },
      resetLocaleData: function () {
        return /* reexport */ resetLocaleData;
      },
      setLocaleData: function () {
        return /* reexport */ setLocaleData;
      },
      sprintf: function () {
        return /* reexport */ sprintf_sprintf;
      },
      subscribe: function () {
        return /* reexport */ subscribe;
      },
    });
    ...
    var sprintf_default = /*#__PURE__*/ __webpack_require__.n(sprintf); // CONCATENATED MODULE: ./node_modules/@wordpress/i18n/build-module/sprintf.js
    /**
    ...
    const createI18n = (initialData, initialDomain, hooks) => {
      ...
      const doSetLocaleData = function (data) {
        ...
        let domain =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : "default";
        tannin.data[domain] = { ...tannin.data[domain], ...data }; // Populate default domain configuration (supported locale date which omits
        // a plural forms expression).

        tannin.data[domain][""] = {
          ...DEFAULT_LOCALE_DATA[""],
          ...((_tannin$data$domain = tannin.data[domain]) === null ||
          _tannin$data$domain === void 0
            ? void 0
            : _tannin$data$domain[""]),
      ...
      const addLocaleData = function (data) {
        ...
        tannin.data[domain] = {
          ...
          "": {
            ...DEFAULT_LOCALE_DATA[""],
            ...((_tannin$data$domain2 = tannin.data[domain]) === null ||
            _tannin$data$domain2 === void 0
              ? void 0
              : _tannin$data$domain2[""]),
    ...
    var external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: ./node_modules/@wordpress/i18n/build-module/default-i18n.js
    /**
    ...
    const i18n = createI18n(
      undefined,
      undefined,
      external_wp_hooks_namespaceObject.defaultHooks
    );
    /**
    ...
    const hasTranslation = i18n.hasTranslation.bind(i18n); // CONCATENATED MODULE: ./node_modules/@wordpress/i18n/build-module/index.js
  })();
