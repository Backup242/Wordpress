...
!(function () {
  ...
  !(function () {
    ...
    function O() {
      ...
      const r = t.indexOf("?");
      return (
        -1 !== r && ((n = Object.assign(A(t), n)), (e = e.substr(0, r))),
        e + "?" + p(n)
      );
    }
    function U(t, n) {
    ...
    function I(t) {
      ...
      const e = A(t),
        r = t.substr(0, n);
      for (
        var o = arguments.length, u = new Array(o > 1 ? o - 1 : 0), i = 1;
        i < o;
        i++
      )
        u[i - 1] = arguments[i];
      ...
      return e
        ? r +
            ...
            e
              .split("&")
              .map((t) => t.split("="))
              .map((t) => t.map(decodeURIComponent))
              .sort((t, n) => t[0].localeCompare(n[0]))
              .map((t) => t.map(encodeURIComponent))
              .map((t) => t.join("="))
              .join("&")
        : r;
    }
