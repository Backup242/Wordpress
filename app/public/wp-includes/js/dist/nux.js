/******/ (function () {
  ...
  var external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: ./node_modules/@wordpress/nux/build-module/store/reducer.js
  /**
  ...
  const getAssociatedGuide = rememo(
    (state, tipId) => {
      for (const tipIds of state.guides) {
        if (tipIds.includes(tipId)) {
          const nonDismissedTips = tipIds.filter(
            (tId) => !Object.keys(state.preferences.dismissedTips).includes(tId)
          );
  ...
  function isTipVisible(state, tipId) {
    ...
    if (
      (_state$preferences$di = state.preferences.dismissedTips) !== null &&
      _state$preferences$di !== void 0 &&
      _state$preferences$di.hasOwnProperty(tipId)
    ) {
      return false;
    }
  ...
  var external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","compose"]
  ...
  var external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/close.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ var library_close = close_close; // CONCATENATED MODULE: ./node_modules/@wordpress/nux/build-module/components/dot-tip/index.js
    ...
    return (0, external_wp_element_namespaceObject.createElement)(
      ...
      (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          hasNextTip
            ? (0, external_wp_i18n_namespaceObject.__)("See next tip")
  ...
  /* harmony default export */ var dot_tip = (0,
  ...
  )(DotTip); // CONCATENATED MODULE: ./node_modules/@wordpress/nux/build-module/index.js
