...
*/
  ...
  !(function () {
    ...
    __webpack_require__.d(store_actions_namespaceObject, {
      ...
      moveBlockToWidgetArea: function () {
        return moveBlockToWidgetArea;
      },
      persistStubPost: function () {
        return persistStubPost;
      },
      saveEditedWidgetAreas: function () {
        return saveEditedWidgetAreas;
      },
      saveWidgetArea: function () {
        return saveWidgetArea;
      },
      saveWidgetAreas: function () {
      ...
      setIsWidgetAreaOpen: function () {
        return setIsWidgetAreaOpen;
      },
      setWidgetAreasOpenState: function () {
        return setWidgetAreasOpenState;
      },
      setWidgetIdForClientId: function () {
    ...
    __webpack_require__.d(store_selectors_namespaceObject, {
      ...
      canInsertBlockInWidgetArea: function () {
        return canInsertBlockInWidgetArea;
      },
      getEditedWidgetAreas: function () {
        return getEditedWidgetAreas;
      },
      getIsWidgetAreaOpen: function () {
        return getIsWidgetAreaOpen;
      },
      getParentWidgetAreaBlock: function () {
        return getParentWidgetAreaBlock;
      },
      getReferenceWidgetBlocks: function () {
        return getReferenceWidgetBlocks;
      },
      getWidget: function () {
        return getWidget;
      },
      getWidgetAreaForWidgetId: function () {
      ...
      isSavingWidgetAreas: function () {
        return isSavingWidgetAreas;
      },
    });
    ...
    var external_wp_blockLibrary_namespaceObject = window["wp"]["blockLibrary"]; // CONCATENATED MODULE: external ["wp","coreData"]
    var external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: external ["wp","widgets"]
    var external_wp_widgets_namespaceObject = window["wp"]["widgets"]; // CONCATENATED MODULE: external ["wp","preferences"]
    var external_wp_preferences_namespaceObject = window["wp"]["preferences"]; // CONCATENATED MODULE: external ["wp","apiFetch"]
    ...
    var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","notices"]
    var external_wp_notices_namespaceObject = window["wp"]["notices"]; // CONCATENATED MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
    function _extends() {
    ...
    var external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: external ["wp","primitives"]
    ...
    } // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/components/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/index.js // CONCATENATED MODULE: external ["wp","blockEditor"]

    var external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/store/transformers.js
    /**
     * WordPress dependencies
     */
    ...
    function transformWidgetToBlock(widget) {
      if (widget.id_base === "block") {
        const parsedBlocks = (0, external_wp_blocks_namespaceObject.parse)(
     ...
     * Module Constants
     */
    const constants_STORE_NAME = "core/edit-widgets"; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/store/actions.js
    ...
    const saveEditedWidgetAreas = () => async (_ref2) => {
      ...
      try {
        ...
        registry
          ...
          .createSuccessNotice(
            (0, external_wp_i18n_namespaceObject.__)("Widgets saved."),
            {
              type: "snackbar",
            }
          );
    ...
    const saveWidgetArea = (widgetAreaId) => async (_ref4) => {
      ...
      for (let i = 0; i < widgetsBlocks.length; i++) {
        ...
        const widgetId = (0,
        external_wp_widgets_namespaceObject.getWidgetIdFromBlock)(block);
        ...
        if (oldWidget) {
          ...
          batchTasks.push((_ref7) => {
            ...
            return saveEntityRecord("root", "widget", {
              ...widget,
    ...
    const moveBlockToWidgetArea =
      (clientId, widgetAreaId) => async (_ref11) => {
    ...
    const selectors_getWidgets = (0,
    external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
      const widgets = select(
        external_wp_coreData_namespaceObject.store
      ).getEntityRecords("root", "widget", buildWidgetsQuery());
      return (
        // Key widgets by their ID.
        (widgets === null || widgets === void 0
          ? void 0
          : widgets.reduce(
              (allWidgets, widget) => ({ ...allWidgets, [widget.id]: widget }),
              {}
            )) || {}
      );
    });
    ...
    const selectors_getWidgetAreas = (0,
    external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
      const query = buildWidgetAreasQuery();
      return select(
        external_wp_coreData_namespaceObject.store
    ...
    const getWidgetAreaForWidgetId = (0,
    external_wp_data_namespaceObject.createRegistrySelector)(
    ...
    const getParentWidgetAreaBlock = (0,
    external_wp_data_namespaceObject.createRegistrySelector)(
      ...
      (select) => (state, ids) => {
        ...
        return widgetAreas
          ...
          .map((_ref3) => {
            ...
            return select(
              external_wp_coreData_namespaceObject.store
            ).getEditedEntityRecord(KIND, WIDGET_AREA_ENTITY_TYPE, id);
          });
      }
    );
    /**
    ...
    const getReferenceWidgetBlocks = (0,
    external_wp_data_namespaceObject.createRegistrySelector)(
      (select) =>
        function (state) {
    ...
    const isSavingWidgetAreas = (0,
    external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
      var _select$getWidgetArea;

      const widgetAreasIds =
        (_select$getWidgetArea =
          select(constants_STORE_NAME).getWidgetAreas()) === null ||
      ...
      for (const id of widgetAreasIds) {
        const isSaving = select(
          external_wp_coreData_namespaceObject.store
        ).isSavingEntityRecord(KIND, WIDGET_AREA_ENTITY_TYPE, id);
      ...
      for (const id of widgetIds) {
        const isSaving = select(
          external_wp_coreData_namespaceObject.store
        ).isSavingEntityRecord("root", "widget", id);
    ...
    const canInsertBlockInWidgetArea = (0,
    external_wp_data_namespaceObject.createRegistrySelector)(
      (select) => (state, blockName) => {
        // Widget areas are always top-level blocks, which getBlocks will return.
        const widgetAreas = select(
          external_wp_blockEditor_namespaceObject.store
        ).getBlocks(); // Makes an assumption that a block that can be inserted into one
        ...
        return select(
          external_wp_blockEditor_namespaceObject.store
        ).canInsertBlockType(blockName, firstWidgetArea.clientId);
      }
    );
    /**
    ...
    var external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/filters/move-to-widget-area.js
    /**
     * WordPress dependencies
     */
    ...
    const withMoveToWidgetAreaToolbarItem = (0,
    ...
    var external_wp_mediaUtils_namespaceObject = window["wp"]["mediaUtils"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/filters/replace-media-upload.js
    /**
     * WordPress dependencies
     */
    ...
    (0, external_wp_hooks_namespaceObject.addFilter)(
      ...
      replaceMediaUpload
    ); // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/filters/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/blocks/widget-area/edit/use-is-dragging-within.js
    ...
    const useIsDraggingWithin = (elementRef) => {
      const [isDraggingWithin, setIsDraggingWithin] = (0,
    ...
    /* harmony default export */ var use_is_dragging_within =
      useIsDraggingWithin; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/blocks/widget-area/edit/inner-blocks.js
    ...
    function WidgetAreaInnerBlocks(_ref) {
      ...
      const innerBlocksProps = (0,
      external_wp_blockEditor_namespaceObject.useInnerBlocksProps)(
        {
          ref: innerBlocksRef,
        },
        {
    ...
    const { name: widget_area_name } = metadata;
    ...
    var external_wp_reusableBlocks_namespaceObject =
      window["wp"]["reusableBlocks"]; // CONCATENATED MODULE: external ["wp","keyboardShortcuts"]
    var external_wp_keyboardShortcuts_namespaceObject =
      window["wp"]["keyboardShortcuts"]; // CONCATENATED MODULE: external ["wp","keycodes"]
    var external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcuts/index.js
    /**
     * WordPress dependencies
     */
    ...
    /* harmony default export */ var keyboard_shortcuts = KeyboardShortcuts; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/hooks/use-last-selected-widget-area.js
    ...
    /* harmony default export */ var use_last_selected_widget_area =
      useLastSelectedWidgetArea; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/constants.js

    const ALLOW_REUSABLE_BLOCKS = false;
    const ENABLE_EXPERIMENTAL_FSE_BLOCKS = false; // CONCATENATED MODULE: external ["wp","privateApis"]

    var external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/private-apis.js
    /**
     * WordPress dependencies
     */
    ...
    function WidgetAreasBlockEditorProvider(_ref) {
      ...
      const mediaPermissions = (0,
      external_wp_coreData_namespaceObject.useResourcePermissions)("media");
      const { reusableBlocks, isFixedToolbarActive, keepCaretInsideBlock } = (0,
      external_wp_data_namespaceObject.useSelect)(
        (select) => ({
          ...
          isFixedToolbarActive: !!select(
            external_wp_preferences_namespaceObject.store
          ).get("core/edit-widgets", "fixedToolbar"),
          keepCaretInsideBlock: !!select(
            external_wp_preferences_namespaceObject.store
          ).get("core/edit-widgets", "keepCaretInsideBlock"),
        }),
        []
      );
    ...
    const cog = (0, external_wp_element_namespaceObject.createElement)(
      external_wp_primitives_namespaceObject.SVG,
      {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
    ...
    /* harmony default export */ var library_cog = cog; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/block-default.js

    /**
     * WordPress dependencies
     */

    const blockDefault = (0, external_wp_element_namespaceObject.createElement)(
      external_wp_primitives_namespaceObject.SVG,
      {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
    ...
    /* harmony default export */ var block_default = blockDefault; // CONCATENATED MODULE: external ["wp","url"]

    var external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: external ["wp","dom"]
    var external_wp_dom_namespaceObject = window["wp"]["dom"]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/sidebar/widget-areas.js
    /**
     * WordPress dependencies
     */
          ...
          (0, external_wp_element_namespaceObject.createElement)(
            ...
            (0, external_wp_element_namespaceObject.createElement)("p", {
              ...
              dangerouslySetInnerHTML: {
                __html: (0, external_wp_dom_namespaceObject.safeHTML)(
                  description
                ),
              },
            }),
    ...
    function Sidebar() {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
              ...
              (0, external_wp_element_namespaceObject.createElement)(
                ComplementaryAreaTab,
                {
                  ...
                  label: selectedWidgetAreaBlock
                    ...
                    : (0, external_wp_i18n_namespaceObject.__)("Widget Areas"),
        ...
        currentArea === WIDGET_AREAS_IDENTIFIER &&
          (0, external_wp_element_namespaceObject.createElement)(WidgetAreas, {
            selectedWidgetAreaId:
    ...
    /* harmony default export */ var library_plus = plus; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/list-view.js
    ...
    /* harmony default export */ var list_view = listView; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/save-button/index.js
    ...
    function SaveButton() {
      const { hasEditedWidgetAreaIds, isSaving } = (0,
    ...
    /* harmony default export */ var save_button = SaveButton; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/undo.js
    ...
    /* harmony default export */ var library_redo = redo; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/header/undo-redo/undo.js
    ...
    /* harmony default export */ var library_external = external; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcut-help-modal/config.js
    ...
    /* harmony default export */ var keyboard_shortcut_help_modal_shortcut =
      Shortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js
    ...
    /* harmony default export */ var dynamic_shortcut = DynamicShortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcut-help-modal/index.js
    ...
    /* harmony default export */ var tools_more_menu_group = ToolsMoreMenuGroup; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/more-menu/index.js
    ...
    function Header() {
      ...
      const isLastSelectedWidgetAreaOpen = (0,
      external_wp_data_namespaceObject.useSelect)(
        (select) => select(store_store).getIsWidgetAreaOpen(widgetAreaClientId),
        [widgetAreaClientId]
      );
      const { isInserterOpen, isListViewOpen } = (0,
      external_wp_data_namespaceObject.useSelect)((select) => {
                ...
                (0, external_wp_element_namespaceObject.createElement)(
                  ...
                  (0, external_wp_element_namespaceObject.createElement)(
                    external_wp_components_namespaceObject.ToolbarItem,
                    {
                      as: external_wp_components_namespaceObject.Button,
                      className:
                        "edit-widgets-header-toolbar__list-view-toggle",
                      icon: list_view,
    ...
    /* harmony default export */ var header = Header; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/notices/index.js
    ...
    /* harmony default export */ var notices = Notices; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/widget-areas-block-editor-content/index.js
    ...
    /* harmony default export */ var library_close = close_close; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/hooks/use-widget-library-insertion-point.js
    ...
    const useWidgetLibraryInsertionPoint = () => {
      const firstRootId = (0, external_wp_data_namespaceObject.useSelect)(
        (select) => {
          var _widgetAreasPost$bloc;
      ...
      return (0, external_wp_data_namespaceObject.useSelect)(
        (select) => {
          ...
          const insertionPoint =
            select(store_store).__experimentalGetInsertionPoint(); // "Browse all" in the quick inserter will set the rootClientId to the current block.
    ...
    /* harmony default export */ var use_widget_library_insertion_point =
      useWidgetLibraryInsertionPoint; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/secondary-sidebar/inserter-sidebar.js
    ...
    function Interface(_ref) {
      ...
      const {
        ...
        (select) => ({
          hasSidebarEnabled: !!select(store).getActiveComplementaryArea(
            store_store.name
          ),
          ...
          hasBlockBreadCrumbsEnabled: !!select(
            external_wp_preferences_namespaceObject.store
          ).get("core/edit-widgets", "showBlockBreadcrumbs"),
          ...
          footer:
            ...
            (0, external_wp_element_namespaceObject.createElement)(
              ...
              (0, external_wp_element_namespaceObject.createElement)(
                ...
                {
                  rootLabelText: (0, external_wp_i18n_namespaceObject.__)(
                    "Widgets"
                  ),
                }
              )
    ...
    /* harmony default export */ var layout_interface = Interface; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/layout/unsaved-changes-warning.js
    ...
    function WelcomeGuide() {
      ...
      const widgetAreas = (0, external_wp_data_namespaceObject.useSelect)(
        (select) =>
          select(store_store).getWidgetAreas({
            per_page: -1,
          }),
        []
      );
    ...
    function Layout(_ref) {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          (0, external_wp_element_namespaceObject.createElement)(Sidebar, null),
          (0, external_wp_element_namespaceObject.createElement)(
    ...
    /* harmony default export */ var layout = Layout; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/index.js
    ...
    function initializeEditor(id, settings) {
      ...
      (0, external_wp_widgets_namespaceObject.registerLegacyWidgetVariations)(
        settings
      );
      ...
      (0, external_wp_blocks_namespaceObject.setFreeformContentHandlerName)(
        "core/html"
      );
      root.render(
    ...
    const registerBlock = (block) => {
      ...
      if (metadata) {
        (0,
        external_wp_blocks_namespaceObject.unstable__bootstrapServerSideBlockDefinitions)(
          {
            [name]: metadata,
          }
        );
