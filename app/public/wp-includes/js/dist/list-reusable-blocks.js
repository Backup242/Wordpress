/******/ (function () {
  ...
  // ESM COMPAT FLAG
  __webpack_require__.r(__webpack_exports__); // CONCATENATED MODULE: external ["wp","element"]

  var external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","i18n"]
  var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/tslib/tslib.es6.js
  /*! *****************************************************************************
...
***************************************************************************** */
  ...
  /* harmony default export */ var utils_export = exportReusableBlock; // CONCATENATED MODULE: external ["wp","compose"]

  var external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","components"]
  var external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: ./node_modules/@wordpress/list-reusable-blocks/build-module/utils/import.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ var utils_import = importReusableBlock; // CONCATENATED MODULE: ./node_modules/@wordpress/list-reusable-blocks/build-module/components/import-form/index.js
  ...
  function ImportForm(_ref) {
    ...
    const [file, setFile] = (0, external_wp_element_namespaceObject.useState)(
      null
    );
        ...
        .catch((errors) => {
          ...
          switch (errors.message) {
            case "Invalid JSON file":
              uiMessage = (0, external_wp_i18n_namespaceObject.__)(
                "Invalid JSON file"
              );
              break;
  ...
  /* harmony default export */ var import_form = (0,
  external_wp_compose_namespaceObject.withInstanceId)(ImportForm); // CONCATENATED MODULE: ./node_modules/@wordpress/list-reusable-blocks/build-module/components/import-dropdown/index.js
      ...
      external_wp_components_namespaceObject.Dropdown,
      {
        ...
        renderContent: (_ref3) => {
          ...
          return (0, external_wp_element_namespaceObject.createElement)(
            import_form,
            {
              onUpload: (0, external_wp_compose_namespaceObject.pipe)(
                onClose,
                onUpload
              ),
            }
  ...
  /* harmony default export */ var import_dropdown = ImportDropdown; // CONCATENATED MODULE: ./node_modules/@wordpress/list-reusable-blocks/build-module/index.js
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const showNotice = () => {
      ...
      notice.innerHTML = `<p>${(0, external_wp_i18n_namespaceObject.__)(
    ...
    (0, external_wp_element_namespaceObject.createRoot)(container).render(
      (0, external_wp_element_namespaceObject.createElement)(import_dropdown, {
        onUpload: showNotice,
      })
    );
  });
