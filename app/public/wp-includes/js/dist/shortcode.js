/******/ (function () {
  ...
  !(function () {
    ...
    /* harmony import */ var memize__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(9756);
    /* harmony import */ var memize__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(memize__WEBPACK_IMPORTED_MODULE_0__);
    /**
    ...
    const attrs = memize__WEBPACK_IMPORTED_MODULE_0___default()((text) => {
      ...
      const pattern =
        /([\w-]+)\s*=\s*"([^"]*)"(?:\s|$)|([\w-]+)\s*=\s*'([^']*)'(?:\s|$)|([\w-]+)\s*=\s*([^\s'"]+)(?:\s|$)|"([^"]*)"(?:\s|$)|'([^']*)'(?:\s|$)|(\S+)(?:\s|$)/g; // Map zero-width spaces to actual spaces.
