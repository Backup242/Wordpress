  ...
  var e = {
      d: function (n, p) {
        for (var r in p)
          e.o(p, r) &&
            !e.o(n, r) &&
            Object.defineProperty(n, r, { enumerable: !0, get: p[r] });
      },
      o: function (e, n) {
  ...
  function t(e) {
    ...
    if (-1 !== (e += "\n").indexOf("<pre")) {
      ...
      for (let r = 0; r < n.length; r++) {
        ...
        const l = "<pre wp-pre-tag-" + r + "></pre>";
        p.push([l, t.substr(c) + "</pre>"]), (e += t.substr(0, c) + l);
      }
      e += r;
    }
    const t =
    ...
    return (
      ...
      (e = (e = (e = (e = (e = (e = (e = (e = e.replace(
        ...
        new RegExp("<p>\\s*(</?" + t + "[^>]*>)", "g"),
        "$1"
      )).replace(new RegExp("(</?" + t + "[^>]*>)\\s*</p>", "g"), "$1")),
      n &&
        (e = (e = (e = (e = e.replace(/<(script|style).*?<\/\\1>/g, (e) =>
          e[0].replace(/\n/g, "<WPPreserveNewline />")
    ...
    return e
      ? ((-1 === e.indexOf("<script") && -1 === e.indexOf("<style")) ||
          (e = e.replace(
            ...
            (e) => (t.push(e), "<wp-preserve>")
          )),
        -1 !== e.indexOf("<pre") &&
          ((c = !0),
          (e = e.replace(/<pre[^>]*>[\s\S]+?<\/pre>/g, (e) =>
            (e = (e = e.replace(
              /<br ?\/?>(\r\n|\n)?/g,
              "<wp-line-break>"
            )).replace(
        ...
        -1 !== e.indexOf("[caption") &&
          ((l = !0),
          (e = e.replace(/\[caption[\s\S]+?\[\/caption\]/g, (e) =>
            e.replace(/<br([^>]*)>/g, "<wp-temp-br$1>").replace(/[\r\n\t]+/, "")
          ))),
        -1 !==
          (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e =
            ...
            new RegExp("\\s*</(" + r + ")>\\s*", "g"),
            "</$1>\n"
          )).replace(/<((li|dt|dd)[^>]*)>/g, " \t<$1>")).indexOf("<option") &&
        ...
        -1 !== e.indexOf("<object") &&
          (e = e.replace(/<object[\s\S]+?<\/object>/g, (e) =>
            e.replace(/[\r\n]+/g, "")
          )),
        ...
        l && (e = e.replace(/<wp-temp-br([^>]*)>/g, "<br$1>")),
        t.length && (e = e.replace(/<wp-preserve>/g, () => t.shift())),
        e)
      : "";
  }
  (window.wp = window.wp || {}).autop = n;
})();
