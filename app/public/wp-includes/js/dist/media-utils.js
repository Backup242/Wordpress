/******/ (function () {
  ...
  var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/components/media-upload/index.js
  /**
  ...
  class MediaUpload extends external_wp_element_namespaceObject.Component {
    ...
    onUpdate(selections) {
      ...
      if (multiple) {
        onSelect(
          selectedImages.models.map((model) => slimImageObject(model.toJSON()))
        );
      } else {
    ...
    onOpen() {
      ...
      const hasMedia = Array.isArray(value)
  ...
  /* harmony default export */ var media_upload = MediaUpload; // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/components/index.js // CONCATENATED MODULE: external ["wp","apiFetch"]

  var external_wp_apiFetch_namespaceObject = window["wp"]["apiFetch"];
  var external_wp_apiFetch_default = /*#__PURE__*/ __webpack_require__.n(
    external_wp_apiFetch_namespaceObject
  ); // CONCATENATED MODULE: external ["wp","blob"]
  var external_wp_blob_namespaceObject = window["wp"]["blob"]; // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/utils/upload-media.js
  /**
   * WordPress dependencies
   */
  ...
  async function uploadMedia(_ref2) {
    ...
    const setAndUpdateFiles = (idx, value) => {
      ...
      (0, external_wp_blob_namespaceObject.revokeBlobURL)(
        (_filesSet$idx = filesSet[idx]) === null || _filesSet$idx === void 0
          ? void 0
          : _filesSet$idx.url
      );
      filesSet[idx] = value;
    ...
    for (let idx = 0; idx < validFiles.length; ++idx) {
      ...
      try {
        ...
        const mediaObject = {
          ...
          caption:
            (_savedMedia$caption$r =
              (_savedMedia$caption = savedMedia.caption) === null ||
              _savedMedia$caption === void 0
                ? void 0
                : _savedMedia$caption.raw) !== null &&
            _savedMedia$caption$r !== void 0
              ? _savedMedia$caption$r
              : "",
  ...
  } // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/utils/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/index.js
