...
!(function () {
  ...
  function f() {
    ...
    switch (i) {
      ...
      case "void-block":
        return 0 === n
          ? (null !== g && o.push(c(e.substr(g, h - g))),
            o.push(l(f, k, [], "", [])),
            (r = h + d),
            !0)
          : (a(l(f, k, [], "", []), h, d), (r = h + d), !0);
      ...
      case "block-closer":
        ...
        const t = u.pop(),
          s = e.substr(t.prevOffset, h - t.prevOffset);
        return (
          (t.block.innerHTML += s),
          t.block.innerContent.push(s),
          (t.prevOffset = h + d),
          a(t.block, t.tokenStart, t.tokenLength, h + d),
          (r = h + d),
          !0
        );
      default:
  ...
  function p(n) {
    const t = n || e.length - r;
    0 !== t && o.push(c(e.substr(r, t)));
  }
  function a(n, t, r, o) {
    const s = u[u.length - 1];
    s.block.innerBlocks.push(n);
    const l = e.substr(s.prevOffset, t - s.prevOffset);
    l && ((s.block.innerHTML += l), s.block.innerContent.push(l)),
      s.block.innerContent.push(null),
      (s.prevOffset = o || t + r);
  }
  function b(n) {
    const {
    ...
    i && ((t.innerHTML += i), t.innerContent.push(i)),
      null !== r && o.push(c(e.substr(r, l - r))),
      o.push(t);
  }
