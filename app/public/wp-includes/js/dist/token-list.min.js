...
!(function () {
  ...
  class t {
    ...
    set value(r) {
      (r = String(r)),
        (this._valueAsArray = [...new Set(r.split(/\s+/g).filter(Boolean))]),
    ...
    *[Symbol.iterator]() {
    ...
    remove() {
      for (var r = arguments.length, e = new Array(r), t = 0; t < r; t++)
        e[t] = arguments[t];
      this.value = this._valueAsArray.filter((r) => !e.includes(r)).join(" ");
    }
    toggle(r, e) {
      return (
        void 0 === e && (e = !this.contains(r)),
        e ? this.add(r) : this.remove(r),
        e
      );
    }
    replace(r, e) {
