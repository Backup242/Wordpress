!(function (t, e) {
        ...
        (this.bodyUsed = this.bodyUsed),
          (this._bodyInit = t)
            ? "string" == typeof t
              ...
              : h && s && (e = t) && DataView.prototype.isPrototypeOf(e)
              ? ((this._bodyArrayBuffer = b(t.buffer)),
                (this._bodyInit = new Blob([this._bodyArrayBuffer])))
              : h && (ArrayBuffer.prototype.isPrototypeOf(t) || r(t))
  ...
  function E(t, e) {
    ...
    if (
      ...
      (this.method =
        ((r = (t = e.method || this.method || "GET").toUpperCase()),
        -1 < w.indexOf(r) ? r : t)),
      ...
      (u.onload = function () {
        var t,
          ...
          o =
            ...
            "response" in u ? u.response : u.responseText);
        setTimeout(function () {
          n(new A(o, r));
        }, 0);
      }),
        ...
        !r || "object" != typeof r.headers || r.headers instanceof d
          ...
          : Object.getOwnPropertyNames(r.headers).forEach(function (t) {
              u.setRequestHeader(t, f(r.headers[t]));
            }),
        a.signal &&
  ...
  (g.polyfill = !0),
    o.fetch ||
      ((o.fetch = g), (o.Headers = d), (o.Request = E), (o.Response = A)),
    (t.Headers = d),
    (t.Request = E),
    (t.Response = A),
    (t.fetch = g),
