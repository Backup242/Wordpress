...
*/
  ...
  !(function () {
    ...
    var external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","blockLibrary"]
    var external_wp_blockLibrary_namespaceObject = window["wp"]["blockLibrary"]; // CONCATENATED MODULE: external ["wp","widgets"]
    var external_wp_widgets_namespaceObject = window["wp"]["widgets"]; // CONCATENATED MODULE: external ["wp","blocks"]
    var external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: external ["wp","data"]
    var external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: external ["wp","preferences"]
    var external_wp_preferences_namespaceObject = window["wp"]["preferences"]; // CONCATENATED MODULE: external ["wp","components"]
    var external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: external ["wp","keyboardShortcuts"]
    var external_wp_keyboardShortcuts_namespaceObject =
      window["wp"]["keyboardShortcuts"]; // CONCATENATED MODULE: external ["wp","i18n"]
    var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","blockEditor"]
    var external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: external ["wp","compose"]
    var external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","hooks"]
    var external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/error-boundary/index.js
    /**
    ...
    var external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: external ["wp","mediaUtils"]
    var external_wp_mediaUtils_namespaceObject = window["wp"]["mediaUtils"]; // CONCATENATED MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
    function _extends() {
    ...
    var classnames_default = /*#__PURE__*/ __webpack_require__.n(classnames); // CONCATENATED MODULE: external ["wp","keycodes"]
    var external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // CONCATENATED MODULE: external ["wp","primitives"]
    var external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/undo.js
    /**
     * WordPress dependencies
     */
    ...
    /* harmony default export */ var library_redo = redo; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/plus.js
    ...
    /* harmony default export */ var library_plus = plus; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/close-small.js
    ...
    /* harmony default export */ var close_small = closeSmall; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/store/reducer.js
     ...
     * Module Constants
     */
    const STORE_NAME = "core/customize-widgets"; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/store/index.js
    ...
    (0, external_wp_data_namespaceObject.register)(store); // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/inserter/index.js
    ...
    function Inserter(_ref) {
      ...
      const inserterTitleId = (0,
      external_wp_compose_namespaceObject.useInstanceId)(
        Inserter,
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          (0, external_wp_element_namespaceObject.createElement)(
            ...
            (0, external_wp_i18n_namespaceObject.__)("Add a block")
          ),
          (0, external_wp_element_namespaceObject.createElement)(
            external_wp_components_namespaceObject.Button,
            {
              className:
                "customize-widgets-layout__inserter-panel-header-close-button",
              icon: close_small,
    ...
    /* harmony default export */ var components_inserter = Inserter; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/external.js
    ...
    /* harmony default export */ var library_external = external; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/more-vertical.js
    ...
    } // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/components/index.js // CONCATENATED MODULE: external ["wp","deprecated"]
     ...
     * @type {string}
     */
    const constants_STORE_NAME = "core/interface"; // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/store/index.js
    ...
    (0, external_wp_data_namespaceObject.register)(store_store); // CONCATENATED MODULE: ./node_modules/@wordpress/interface/build-module/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/config.js
    ...
    /* harmony default export */ var keyboard_shortcut_help_modal_shortcut =
      Shortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js
    ...
    /* harmony default export */ var dynamic_shortcut = DynamicShortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/index.js
    ...
    const ShortcutList = (_ref) => {
      ...
      return (
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          {
            className:
              "customize-widgets-keyboard-shortcut-help-modal__shortcut-list",
            role: "list",
          },
    ...
    function KeyboardShortcutHelpModal(_ref4) {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          {
            className:
              "customize-widgets-keyboard-shortcut-help-modal__main-shortcuts",
          ...
          (0, external_wp_element_namespaceObject.createElement)(
            ...
            (0, external_wp_element_namespaceObject.createElement)(
              external_wp_components_namespaceObject.ToolbarButton,
              {
                ...
                className:
                  "customize-widgets-editor-history-button undo-button",
              }
            ),
            (0, external_wp_element_namespaceObject.createElement)(
              external_wp_components_namespaceObject.ToolbarButton,
              {
                ...
                className:
                  "customize-widgets-editor-history-button redo-button",
              }
            ),
            (0, external_wp_element_namespaceObject.createElement)(
              external_wp_components_namespaceObject.ToolbarButton,
    ...
    /* harmony default export */ var header = Header; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/inserter/use-inserter.js
    ...
    var es6_default = /*#__PURE__*/ __webpack_require__.n(es6); // CONCATENATED MODULE: external ["wp","isShallowEqual"]
    ...
    function blockToWidget(block) {
      ...
      return { ...restExistingWidget, ...widget };
    }
    /**
    ...
    function widgetToBlock(_ref) {
      ...
      if (idBase === "block") {
        ...
        const parsedBlocks = (0, external_wp_blocks_namespaceObject.parse)(
          (_raw$content = raw.content) !== null && _raw$content !== void 0
            ? _raw$content
            : "",
          {
        ...
        (nextBlocks) => {
          setBlocks((prevBlocks) => {
            ...
            const nextWidgets = nextBlocks.map((nextBlock) => {
              const widgetId = (0,
              external_wp_widgets_namespaceObject.getWidgetIdFromBlock)(
                nextBlock
            ...
            return nextBlocks.reduce((updatedNextBlocks, nextBlock, index) => {
              ...
              if (addedWidgetId !== null) {
                ...
                updatedNextBlocks[index] = (0,
                external_wp_widgets_namespaceObject.addWidgetIdToBlock)(
                  nextBlock,
                  addedWidgetId
                );
              }
    ...
    const useFocusControl = () =>
      (0, external_wp_element_namespaceObject.useContext)(FocusControlContext); // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/focus-control/use-blocks-focus-control.js
      ...
      (0, external_wp_element_namespaceObject.useEffect)(() => {
        if (focusedWidgetIdRef.current) {
          ...
          if (focusedBlock) {
            ...
            blockNode === null || blockNode === void 0
              ? void 0
              : blockNode.focus();
          }
        }
    ...
    var external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/private-apis.js
    /**
     * WordPress dependencies
     */
    ...
    function WelcomeGuide(_ref) {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          (0, external_wp_i18n_namespaceObject.__)("Welcome to block Widgets")
        ),
        (0, external_wp_element_namespaceObject.createElement)(
          "p",
          {
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          (0, external_wp_i18n_namespaceObject.__)("Got it")
        ),
        (0, external_wp_element_namespaceObject.createElement)("hr", {
        ...
        !isEntirelyBlockWidgets &&
          (0, external_wp_element_namespaceObject.createElement)(
            ...
            (0, external_wp_element_namespaceObject.createElement)("br", null),
            (0, external_wp_element_namespaceObject.createElement)(
    ...
    function KeyboardShortcutsRegister() {
      const { registerShortcut, unregisterShortcut } = (0,
      external_wp_data_namespaceObject.useDispatch)(
        external_wp_keyboardShortcuts_namespaceObject.store
      );
      (0, external_wp_element_namespaceObject.useEffect)(() => {
    ...
    /* harmony default export */ var keyboard_shortcuts = KeyboardShortcuts; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/components/block-appender/index.js
    ...
    function BlockAppender(props) {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
        external_wp_blockEditor_namespaceObject.ButtonBlockAppender,
        _extends({}, props, {
          ref: ref,
        })
      );
      ...
      const {
        ...
        return {
          hasUploadPermissions:
            ...
            ).canUser("create", "media")) !== null && _select$canUser !== void 0
              ? _select$canUser
              : true,
    ...
    const SidebarControlsContext = (0,
    external_wp_element_namespaceObject.createContext)();
    ...
    function useSidebarControls() {
      const { sidebarControls } = (0,
      external_wp_element_namespaceObject.useContext)(SidebarControlsContext);
      return sidebarControls;
    }
    function useActiveSidebarControl() {
      const { activeSidebarControl } = (0,
      external_wp_element_namespaceObject.useContext)(SidebarControlsContext);
    ...
    function useClearSelectedBlock(sidebarControl, popoverRef) {
      const { hasSelectedBlock, hasMultiSelection } = (0,
      external_wp_data_namespaceObject.useSelect)(
        external_wp_blockEditor_namespaceObject.store
      );
          ...
          const args = {
            ...
            completeCallback() {
              ...
              controls.forEach((control) => {
                ...
                (_control$onChangeSect = control.onChangeSectionExpanded) ===
                  null || _control$onChangeSect === void 0
                  ? void 0
    ...
    var external_wp_dom_namespaceObject = window["wp"]["dom"]; // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/controls/inserter-outer-section.js
    /**
     * WordPress dependencies
     */
    ...
    function getInserterOuterSection() {
      ...
      return class InserterOuterSection extends customize.OuterSection {
        constructor() {
          ...
          const ownerWindow =
            this.contentContainer[0].ownerDocument.defaultView; // Handle closing the inserter when pressing the Escape key.
          ...
          ownerWindow.addEventListener(
            ...
            (event) => {
              if (
                this.expanded() &&
                (event.keyCode ===
                  external_wp_keycodes_namespaceObject.ESCAPE ||
                  event.code === "Escape") &&
          ...
          this.expanded.bind(() => {
            if (!this.isFromInternalAction) {
              ...
              (0, external_wp_data_namespaceObject.dispatch)(
                store
              ).setIsInserterOpened(this.expanded());
            }
          ...
          if (!this.expanded()) {
            ...
            this.expand({
              completeCallback() {
                ...
                const searchBox =
                  external_wp_dom_namespaceObject.focus.tabbable.find(
                    contentContainer
                  )[1];
    ...
    const withMoveToSidebarToolbarItem = (0,
    external_wp_compose_namespaceObject.createHigherOrderComponent)(
      (BlockEdit) => (props) => {
        let widgetId = (0,
        external_wp_widgets_namespaceObject.getWidgetIdFromBlock)(props);
        ...
        const canInsertBlockInSidebar = (0,
        external_wp_data_namespaceObject.useSelect)(
          (select) => {
        ...
        const block = (0, external_wp_data_namespaceObject.useSelect)(
          (select) =>
            select(external_wp_blockEditor_namespaceObject.store).getBlock(
              clientId
            ),
          [clientId]
        );
            ...
            (0, external_wp_element_namespaceObject.createElement)(
              ...
              (0, external_wp_element_namespaceObject.createElement)(
                external_wp_widgets_namespaceObject.MoveToWidgetArea,
                {
                  ...
                  currentWidgetAreaId:
                    activeSidebarControl === null ||
                    activeSidebarControl === void 0
                      ? void 0
      ...
      (BlockEdit) => (props) => {
        ...
        const isWide =
          (_wp$customize$Widgets =
            (_wp$customize$Widgets2 =
              wide_widget_display_wp.customize.Widgets.data.availableWidgets.find(
                (widget) => widget.id_base === idBase
              )) === null || _wp$customize$Widgets2 === void 0
              ? void 0
              : _wp$customize$Widgets2.is_wide) !== null &&
          _wp$customize$Widgets !== void 0
            ? _wp$customize$Widgets
            : false;
        return (0, external_wp_element_namespaceObject.createElement)(
          BlockEdit,
    ...
    (0, external_wp_hooks_namespaceObject.addFilter)(
      ...
      withWideWidgetDisplay
    ); // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/filters/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/customize-widgets/build-module/index.js
    ...
    function initialize(editorName, blockEditorSettings) {
      (0, external_wp_data_namespaceObject.dispatch)(
        external_wp_preferences_namespaceObject.store
      ).setDefaults("core/customize-widgets", {
        fixedToolbar: false,
        welcomeGuide: true,
      });
      ...
      build_module_wp.customize.sectionConstructor.sidebar =
        getSidebarSection();
      build_module_wp.customize.controlConstructor.sidebar_block_editor =
        SidebarControl;
      ...
      build_module_wp.customize.bind("ready", () => {
        ...
        (0, external_wp_element_namespaceObject.render)(
          (0, external_wp_element_namespaceObject.createElement)(
            CustomizeWidgets,
            {
