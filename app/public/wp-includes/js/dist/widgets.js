...
*/
  ...
  !(function () {
    ...
    __webpack_require__.d(__webpack_exports__, {
      MoveToWidgetArea: function () {
        return /* reexport */ MoveToWidgetArea;
      },
      addWidgetIdToBlock: function () {
        return /* reexport */ addWidgetIdToBlock;
      },
      getWidgetIdFromBlock: function () {
        return /* reexport */ getWidgetIdFromBlock;
      },
      registerLegacyWidgetBlock: function () {
        return /* binding */ registerLegacyWidgetBlock;
      },
      registerLegacyWidgetVariations: function () {
        return /* reexport */ registerLegacyWidgetVariations;
      },
      registerWidgetGroupBlock: function () {
        return /* binding */ registerWidgetGroupBlock;
      },
    });
    ...
    __webpack_require__.d(widget_group_namespaceObject, {
      metadata: function () {
        return widget_group_metadata;
      },
      name: function () {
        return widget_group_name;
      },
      settings: function () {
        return widget_group_settings;
      },
    }); // CONCATENATED MODULE: external ["wp","blocks"]

    var external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: external ["wp","element"]
    var external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","primitives"]
    var external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/widget.js
    /**
     * WordPress dependencies
     */

    const widget = (0, external_wp_element_namespaceObject.createElement)(
    ...
    var classnames_default = /*#__PURE__*/ __webpack_require__.n(classnames); // CONCATENATED MODULE: external ["wp","blockEditor"]
    var external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: external ["wp","components"]
    var external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/brush.js
    /**
     * WordPress dependencies
     */

    const brush = (0, external_wp_element_namespaceObject.createElement)(
      external_wp_primitives_namespaceObject.SVG,
      {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
    ...
    /* harmony default export */ var library_brush = brush; // CONCATENATED MODULE: external ["wp","i18n"]

    var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","data"]
    var external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: external ["wp","coreData"]
    var external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/legacy-widget/edit/widget-type-selector.js
    /**
     * WordPress dependencies
     */

    function WidgetTypeSelector(_ref) {
      let { selectedId, onSelect } = _ref;
      const widgetTypes = (0, external_wp_data_namespaceObject.useSelect)(
        (select) => {
          var _select$getSettings$w, _select$getSettings, _select$getWidgetType;

          const hiddenIds =
            (_select$getSettings$w =
              (_select$getSettings = select(
                external_wp_blockEditor_namespaceObject.store
              ).getSettings()) === null || _select$getSettings === void 0
                ? void 0
                : _select$getSettings.widgetTypesToHideFromLegacyWidgetBlock) !==
              null && _select$getSettings$w !== void 0
              ? _select$getSettings$w
              : [];
          return (_select$getWidgetType = select(
            external_wp_coreData_namespaceObject.store
          ).getWidgetTypes({
            per_page: -1,
          })) === null || _select$getWidgetType === void 0
            ? void 0
            : _select$getWidgetType.filter(
                (widgetType) => !hiddenIds.includes(widgetType.id)
              );
        },
        []
      );
    ...
    var external_wp_notices_namespaceObject = window["wp"]["notices"]; // CONCATENATED MODULE: external ["wp","compose"]
    var external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","apiFetch"]
    ...
    class Control {
      ...
      constructor(_ref) {
        ...
        external_wp_compose_namespaceObject.debounce)(
                ...
                (this.form = el(
                  ...
                  [
                    ...
                    el("input", {
                      ...
                      name: "widget-id",
                      value:
                        (_this$id = this.id) !== null && _this$id !== void 0
                          ? _this$id
                          : `${this.idBase}-${this.number}`,
                    }),
                    el("input", {
                      class: "id_base",
                      type: "hidden",
    ...
    async function encodeWidget(_ref2) {
      let { idBase, instance, number, formData = null } = _ref2;
    ...
    function Form(_ref) {
      ...
      external_wp_compose_namespaceObject.useViewportMatch)("small"); // We only want to remount the control when the instance changes
      // *externally*. For example, if the user performs an undo. To do this, we
      // keep track of changes made to instance by the control itself and then
      // ignore those.

      const outgoingInstances = (0, external_wp_element_namespaceObject.useRef)(
        new Set()
      );
      const incomingInstances = (0, external_wp_element_namespaceObject.useRef)(
        new Set()
      );
        ...
        (iframe) => {
          ...
          function setHeight() {
            var _iframe$contentDocume,
              _iframe$contentDocume2,
              _iframe$contentDocume3,
              _iframe$contentDocume4;

            // Pick the maximum of these two values to account for margin collapsing.
            const height = Math.max(
              (_iframe$contentDocume =
                (_iframe$contentDocume2 =
                  iframe.contentDocument.documentElement) === null ||
                _iframe$contentDocume2 === void 0
                  ? void 0
                  : _iframe$contentDocume2.offsetHeight) !== null &&
                _iframe$contentDocume !== void 0
                ? _iframe$contentDocume
                : 0,
              (_iframe$contentDocume3 =
                (_iframe$contentDocume4 = iframe.contentDocument.body) ===
                  null || _iframe$contentDocume4 === void 0
                  ? void 0
                  : _iframe$contentDocume4.offsetHeight) !== null &&
                _iframe$contentDocume3 !== void 0
                ? _iframe$contentDocume3
                : 0
          ...
          const { IntersectionObserver } = iframe.ownerDocument.defaultView; // Observe for intersections that might cause a change in the height of
    ...
    function NoPreview(_ref) {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          "p",
          null,
          (0, external_wp_i18n_namespaceObject.__)("No preview available.")
        )
      );
    ...
    function Edit(props) {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(
        ...
        blockProps,
        !id && !idBase
          ? (0, external_wp_element_namespaceObject.createElement)(Empty, props)
          : (0, external_wp_element_namespaceObject.createElement)(
              NotEmpty,
              props
            )
    ...
    function NotEmpty(_ref3) {
      ...
      const { record: widgetType, hasResolved: hasResolvedWidgetType } = (0,
      external_wp_coreData_namespaceObject.useEntityRecord)(
        "root",
        "widgetType",
        widgetTypeId
      );
      const isNavigationMode = (0, external_wp_data_namespaceObject.useSelect)(
        (select) =>
          select(
            external_wp_blockEditor_namespaceObject.store
          ).isNavigationMode(),
      ...
      const setInstance = (0, external_wp_element_namespaceObject.useCallback)(
        (nextInstance) => {
          setAttributes({
    ...
    const legacyWidgetTransforms = [
      ...
      },
      {
        ...
        widget: "recent-posts",
        transform: (_ref3) => {
          let { show_date: displayPostDate, number } = _ref3;
          return {
      ...
      },
      {
        ...
        widget: "categories",
        transform: (_ref6) => {
          let { count, dropdown, hierarchical } = _ref6;
          return {
            displayAsDropdown: !!dropdown,
            showPostCounts: !!count,
      ...
      },
      {
        ...
        widget: "media_audio",
        transform: (_ref7) => {
          let { url, preload, loop, attachment_id: id } = _ref7;
          return {
            src: url,
            id,
            preload,
      ...
      },
      {
        ...
        widget: "media_video",
        transform: (_ref8) => {
          let { url, preload, loop, attachment_id: id } = _ref8;
          return {
            src: url,
            id,
            preload,
      ...
      },
      {
        ...
        transform: (_ref10) => {
          let { ids, link_type: linkTo, size, number } = _ref10;
          return {
            ids,
            columns: number,
            linkTo,
      ...
      let { block, widget, transform } = _ref12;
      return {
        type: "block",
        blocks: [block],
        isMatch: (_ref13) => {
          let { idBase, instance } = _ref13;
          return (
            idBase === widget &&
            !!(instance !== null && instance !== void 0 && instance.raw)
          );
        },
        transform: (_ref14) => {
          var _instance$raw;
          ...
          let { instance } = _ref14;
          const transformedBlock = (0,
          external_wp_blocks_namespaceObject.createBlock)(
            block,
          ...
          if (
            !(
              (_instance$raw = instance.raw) !== null &&
              _instance$raw !== void 0 &&
              _instance$raw.title
            )
          ) {
    ...
    /* harmony default export */ var legacy_widget_transforms = transforms; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/legacy-widget/index.js
    ...
    const { name: legacy_widget_name } = metadata;
    ...
    const group = (0, external_wp_element_namespaceObject.createElement)(
      external_wp_primitives_namespaceObject.SVG,
      {
        viewBox: "0 0 24 24",
        xmlns: "http://www.w3.org/2000/svg",
    ...
    /* harmony default export */ var library_group = group; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/widget-group/edit.js
    ...
    function PreviewContent(_ref2) {
      ...
      let { attributes, setAttributes } = _ref2;
      return (0, external_wp_element_namespaceObject.createElement)(
        external_wp_element_namespaceObject.Fragment,
        null,
        (0, external_wp_element_namespaceObject.createElement)(
          external_wp_blockEditor_namespaceObject.RichText,
          {
            ...
            value:
              (_attributes$title = attributes.title) !== null &&
              _attributes$title !== void 0
                ? _attributes$title
                : "",
            onChange: (title) =>
              setAttributes({
    ...
    /* harmony default export */ var deprecated = [v1]; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/blocks/widget-group/index.js
    ...
    const { name: widget_group_name } = widget_group_metadata;
        ...
        from: [
          {
            ...
            __experimentalConvert(blocks) {
              ...
              const firstHeadingBlock =
                innerBlocks[0].name === "core/heading" ? innerBlocks[0] : null; // Remove the first heading block as we're copying
    ...
    const moveTo = (0, external_wp_element_namespaceObject.createElement)(
      external_wp_primitives_namespaceObject.SVG,
      {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
    ...
    /* harmony default export */ var move_to = moveTo; // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/components/move-to-widget-area/index.js
    ...
    function MoveToWidgetArea(_ref) {
      let { currentWidgetAreaId, widgetAreas, onSelect } = _ref;
      return (0, external_wp_element_namespaceObject.createElement)(
    ...
    } // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/components/index.js // CONCATENATED MODULE: ./node_modules/@wordpress/widgets/build-module/utils.js
    ...
    function registerLegacyWidgetVariations(settings) {
      const unsubscribe = (0, external_wp_data_namespaceObject.subscribe)(
        () => {
          ...
          const hiddenIds =
            (_settings$widgetTypes =
              settings === null || settings === void 0
                ? void 0
                : settings.widgetTypesToHideFromLegacyWidgetBlock) !== null &&
            _settings$widgetTypes !== void 0
              ? _settings$widgetTypes
              : [];
          const widgetTypes =
            (_select$getWidgetType = (0,
    ...
    function registerLegacyWidgetBlock() {
      ...
      const { metadata, settings, name } = legacy_widget_namespaceObject;
      (0, external_wp_blocks_namespaceObject.registerBlockType)(
        {
          name,
          ...metadata,
        },
        { ...settings, supports: { ...settings.supports, ...supports } }
      );
    }
    /**
    ...
    function registerWidgetGroupBlock() {
      let supports =
        arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      const { metadata, settings, name } = widget_group_namespaceObject;
      (0, external_wp_blocks_namespaceObject.registerBlockType)(
        {
          name,
          ...metadata,
