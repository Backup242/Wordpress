/******/ (function () {
  ...
  __webpack_require__.d(selectors_namespaceObject, {
    getDownloadableBlocks: function () {
      return getDownloadableBlocks;
    },
    getErrorNoticeForBlock: function () {
      return getErrorNoticeForBlock;
    },
    getErrorNotices: function () {
      return getErrorNotices;
    },
    getInstalledBlockTypes: function () {
      return getInstalledBlockTypes;
    },
    getNewBlockTypes: function () {
      return getNewBlockTypes;
    },
    getUnusedBlockTypes: function () {
      return getUnusedBlockTypes;
    },
    isInstalling: function () {
      return isInstalling;
    },
    isRequestingDownloadableBlocks: function () {
  ...
  __webpack_require__.d(actions_namespaceObject, {
    addInstalledBlockType: function () {
      return addInstalledBlockType;
    },
    clearErrorNotice: function () {
      return clearErrorNotice;
    },
    fetchDownloadableBlocks: function () {
      return fetchDownloadableBlocks;
    },
    installBlockType: function () {
      return installBlockType;
    },
    receiveDownloadableBlocks: function () {
      return receiveDownloadableBlocks;
    },
    removeInstalledBlockType: function () {
      return removeInstalledBlockType;
    },
    setErrorNotice: function () {
      return setErrorNotice;
    },
    setIsInstalling: function () {
      return setIsInstalling;
    },
    uninstallBlockType: function () {
      return uninstallBlockType;
    },
  });
  ...
  __webpack_require__.d(resolvers_namespaceObject, {
    getDownloadableBlocks: function () {
      return resolvers_getDownloadableBlocks;
    },
  }); // CONCATENATED MODULE: external ["wp","element"]

  var external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","plugins"]
  var external_wp_plugins_namespaceObject = window["wp"]["plugins"]; // CONCATENATED MODULE: external ["wp","hooks"]
  var external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // CONCATENATED MODULE: external ["wp","blocks"]
  var external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // CONCATENATED MODULE: external ["wp","data"]
  var external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: external ["wp","editor"]
  var external_wp_editor_namespaceObject = window["wp"]["editor"]; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/store/reducer.js
  /**
  ...
  var external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/store/utils/has-block-type.js
  /**
  ...
  function isRequestingDownloadableBlocks(state, filterValue) {
    ...
    return (_state$downloadableBl =
      (_state$downloadableBl2 = state.downloadableBlocks[filterValue]) ===
        null || _state$downloadableBl2 === void 0
        ? void 0
        : _state$downloadableBl2.isRequesting) !== null &&
      _state$downloadableBl !== void 0
      ? _state$downloadableBl
      : false;
  }
  /**
  ...
  function getDownloadableBlocks(state, filterValue) {
    ...
    return (_state$downloadableBl3 =
      (_state$downloadableBl4 = state.downloadableBlocks[filterValue]) ===
        null || _state$downloadableBl4 === void 0
        ? void 0
        : _state$downloadableBl4.results) !== null &&
      _state$downloadableBl3 !== void 0
  ...
  var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: external ["wp","apiFetch"]
  var external_wp_apiFetch_namespaceObject = window["wp"]["apiFetch"];
  var external_wp_apiFetch_default = /*#__PURE__*/ __webpack_require__.n(
    external_wp_apiFetch_namespaceObject
  ); // CONCATENATED MODULE: external ["wp","notices"]
  var external_wp_notices_namespaceObject = window["wp"]["notices"]; // CONCATENATED MODULE: external ["wp","url"]
  var external_wp_url_namespaceObject = window["wp"]["url"]; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/store/load-assets.js
  /**
   * WordPress dependencies
   */
  ...
  const installBlockType = (block) => async (_ref) => {
    ...
    try {
          ...
          external_wp_blocks_namespaceObject.unstable__bootstrapServerSideBlockDefinitions)(
            {
              [name]: Object.fromEntries(
                Object.entries(response).filter((_ref2) => {
                  let [key] = _ref2;
      ...
      let message =
        error.message ||
        (0, external_wp_i18n_namespaceObject.__)("An error occurred."); // Errors we throw are fatal.
      ...
      const fatalAPIErrors = {
        ...
        unable_to_connect_to_filesystem: (0,
...
***************************************************************************** */
  ...
  const resolvers_getDownloadableBlocks = (filterValue) => async (_ref) => {
    ...
    try {
      ...
      const blocks = results.map((result) =>
        Object.fromEntries(
          Object.entries(result).map((_ref2) => {
            let [key, value] = _ref2;
  ...
  (0, external_wp_data_namespaceObject.register)(store); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/auto-block-uninstaller/index.js
    ...
    (0, external_wp_element_namespaceObject.useEffect)(() => {
      if (shouldRemoveBlockTypes && unusedBlockTypes.length) {
        unusedBlockTypes.forEach((blockType) => {
          ...
          (0, external_wp_blocks_namespaceObject.unregisterBlockType)(
            blockType.name
          );
        });
      }
  ...
  var external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: external ["wp","components"]
  var external_wp_components_namespaceObject = window["wp"]["components"]; // CONCATENATED MODULE: external ["wp","coreData"]
  var external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // CONCATENATED MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
  function _extends() {
  ...
  var external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/icon/index.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ var icon = Icon; // CONCATENATED MODULE: external ["wp","primitives"]

  var external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/star-filled.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ var star_filled = starFilled; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/star-half.js

  /**
   * WordPress dependencies
   */

  const starHalf = (0, external_wp_element_namespaceObject.createElement)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
  ...
  /* harmony default export */ var star_half = starHalf; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/star-empty.js
  ...
  /* harmony default export */ var star_empty = starEmpty; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/block-ratings/stars.js
  ...
  /* harmony default export */ var stars = Stars; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/block-ratings/index.js
  ...
  /* harmony default export */ var block_ratings = BlockRatings; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-icon/index.js
  ...
  /* harmony default export */ var downloadable_block_icon =
    DownloadableBlockIcon; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-notice/index.js
  ...
  /* harmony default export */ var downloadable_block_notice =
    DownloadableBlockNotice; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-list-item/index.js
  ...
  function getDownloadableBlockLabel(_ref, _ref2) {
    let { title, rating, ratingCount } = _ref;
    let { hasNotice, isInstalled, isInstalling } = _ref2;
    const stars = Math.round(rating / 0.5) * 0.5;
  ...
  function DownloadableBlockListItem(_ref3) {
    let { composite, item, onClick } = _ref3;
    const { author, description, icon, rating, title } = item; // getBlockType returns a block object if this block exists, or null if not.

    const isInstalled = !!(0, external_wp_blocks_namespaceObject.getBlockType)(
      item.name
    );
    const { hasNotice, isInstalling, isInstallable } = (0,
          ...
          : (0, external_wp_element_namespaceObject.createElement)(
              ...
              isInstallable &&
                ...
                (0, external_wp_element_namespaceObject.createElement)(
                  ...
                  null,
                  (0, external_wp_i18n_namespaceObject.__)("Install block")
                )
            )
      )
    );
  ...
  /* harmony default export */ var downloadable_block_list_item =
    DownloadableBlockListItem; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-list/index.js
        ...
        return (0, external_wp_element_namespaceObject.createElement)(
          downloadable_block_list_item,
          {
            ...
            onClick: () => {
              ...
              if (
                (0, external_wp_blocks_namespaceObject.getBlockType)(item.name)
              ) {
                onSelect(item);
              } else {
  ...
  /* harmony default export */ var downloadable_blocks_list =
    DownloadableBlocksList; // CONCATENATED MODULE: external ["wp","a11y"]

  var external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-panel/inserter-panel.js
  /**
   * WordPress dependencies
   */

  function DownloadableBlocksInserterPanel(_ref) {
    let { children, downloadableItems, hasLocalBlocks } = _ref;
      ...
      (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          ...
          (0, external_wp_element_namespaceObject.createElement)(
            ...
            (0, external_wp_i18n_namespaceObject.__)("Available to install")
          ),
          (0, external_wp_element_namespaceObject.createElement)(
            "p",
            {
  ...
  /* harmony default export */ var inserter_panel =
    DownloadableBlocksInserterPanel; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/block-default.js
  ...
  /* harmony default export */ var block_default = blockDefault; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-panel/no-results.js
  ...
  function DownloadableBlocksNoResults() {
    return (0, external_wp_element_namespaceObject.createElement)(
      ...
      (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          external_wp_components_namespaceObject.Tip,
          null,
          (0, external_wp_i18n_namespaceObject.__)(
  ...
  /* harmony default export */ var no_results = DownloadableBlocksNoResults; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-panel/index.js
  ...
  ])(DownloadableBlocksPanel); // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/plugins/inserter-menu-downloadable-blocks-panel/index.js
  ...
  function InserterMenuDownloadableBlocksPanel() {
    ...
    external_wp_compose_namespaceObject.debounce)(setFilterValue, 400);
    return (0, external_wp_element_namespaceObject.createElement)(
      external_wp_blockEditor_namespaceObject.__unstableInserterMenuExtension,
      null,
      (_ref) => {
        let { onSelect, onHover, filterValue, hasItems, rootClientId } = _ref;
  ...
  /* harmony default export */ var inserter_menu_downloadable_blocks_panel =
    InserterMenuDownloadableBlocksPanel; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/compact-list/index.js
  ...
  function CompactList(_ref) {
    ...
    return (0, external_wp_element_namespaceObject.createElement)(
      ...
      items.map((_ref2) => {
        let { icon, id, title, author } = _ref2;
        return (0, external_wp_element_namespaceObject.createElement)(
          "li",
          {
            key: id,
  ...
  const { PluginPrePublishPanel } =
    (_window$wp$editPost =
      (_window = window) === null || _window === void 0
        ? void 0
        : (_window$wp = _window.wp) === null || _window$wp === void 0
        ? void 0
        : _window$wp.editPost) !== null && _window$wp$editPost !== void 0
      ? _window$wp$editPost
      : {};
  function InstalledBlocksPrePublishPanel() {
    ...
    return (0, external_wp_element_namespaceObject.createElement)(
      ...
      (0, external_wp_element_namespaceObject.createElement)(CompactList, {
        items: newBlockTypes,
      })
    );
  ...
  function InstallButton(_ref) {
    let { attributes, block, clientId } = _ref;
    ...
    const { installBlockType } = (0,
    external_wp_data_namespaceObject.useDispatch)(store);
    const { replaceBlock } = (0, external_wp_data_namespaceObject.useDispatch)(
      external_wp_blockEditor_namespaceObject.store
    );
    return (0, external_wp_element_namespaceObject.createElement)(
      external_wp_components_namespaceObject.Button,
      {
        onClick: () =>
          installBlockType(block).then((success) => {
            if (success) {
              const blockType = (0,
              external_wp_blocks_namespaceObject.getBlockType)(block.name);
              const [originalBlock] = (0,
              external_wp_blocks_namespaceObject.parse)(
  ...
  const getInstallMissing = (OriginalComponent) => (props) => {
    const { originalName } = props.attributes; // Disable reason: This is a valid component, but it's mistaken for a callback.
    // eslint-disable-next-line react-hooks/rules-of-hooks

    const { block, hasPermission } = (0,
    external_wp_data_namespaceObject.useSelect)(
      (select) => {
  ...
  const ModifiedWarning = (_ref2) => {
    ...
    const hasHTMLBlock = (0, external_wp_data_namespaceObject.useSelect)(
      (select) => {
        const { canInsertBlockType, getBlockRootClientId } = select(
          external_wp_blockEditor_namespaceObject.store
        );
    ...
    const actions = [
      (0, external_wp_element_namespaceObject.createElement)(InstallButton, {
        key: "install",
        block: originalBlock,
  ...
  /* harmony default export */ var get_install_missing = getInstallMissing; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/plugins/index.js
  ...
  (0, external_wp_plugins_namespaceObject.registerPlugin)("block-directory", {
    render() {
      return (0, external_wp_element_namespaceObject.createElement)(
        ...
        (0, external_wp_element_namespaceObject.createElement)(
          inserter_menu_downloadable_blocks_panel,
          null
        ),
        (0, external_wp_element_namespaceObject.createElement)(
