/******/ (function () {
  ...
  __webpack_require__.d(__webpack_exports__, {
    __UNSTABLE_LINE_SEPARATOR: function () {
      return /* reexport */ LINE_SEPARATOR;
    },
    __experimentalRichText: function () {
      return /* reexport */ __experimentalRichText;
    },
    __unstableCreateElement: function () {
      return /* reexport */ createElement;
    },
    __unstableFormatEdit: function () {
      return /* reexport */ FormatEdit;
    },
    __unstableInsertLineSeparator: function () {
      return /* reexport */ insertLineSeparator;
    },
    __unstableIsEmptyLine: function () {
      return /* reexport */ isEmptyLine;
    },
    __unstableToDom: function () {
      return /* reexport */ toDom;
    },
    __unstableUseRichText: function () {
      return /* reexport */ useRichText;
    },
    applyFormat: function () {
      return /* reexport */ applyFormat;
    },
    concat: function () {
      return /* reexport */ concat;
    },
    create: function () {
      return /* reexport */ create;
    },
    getActiveFormat: function () {
      return /* reexport */ getActiveFormat;
    },
    getActiveFormats: function () {
      return /* reexport */ getActiveFormats;
    },
    getActiveObject: function () {
      return /* reexport */ getActiveObject;
    },
    getTextContent: function () {
      return /* reexport */ getTextContent;
    },
    insert: function () {
      return /* reexport */ insert;
    },
    insertObject: function () {
      return /* reexport */ insertObject;
    },
    isCollapsed: function () {
      return /* reexport */ isCollapsed;
    },
    isEmpty: function () {
      return /* reexport */ isEmpty;
    },
    join: function () {
      return /* reexport */ join;
    },
    registerFormatType: function () {
      return /* reexport */ registerFormatType;
    },
    remove: function () {
      return /* reexport */ remove;
    },
    removeFormat: function () {
      return /* reexport */ removeFormat;
    },
    replace: function () {
      return /* reexport */ replace_replace;
    },
    slice: function () {
    ...
    toHTMLString: function () {
      return /* reexport */ toHTMLString;
    },
    toggleFormat: function () {
      return /* reexport */ toggleFormat;
    },
    unregisterFormatType: function () {
      return /* reexport */ unregisterFormatType;
    },
    useAnchor: function () {
      return /* reexport */ useAnchor;
    },
    useAnchorRef: function () {
      return /* reexport */ useAnchorRef;
    },
  });
  ...
  __webpack_require__.d(selectors_namespaceObject, {
    ...
    getFormatTypeForBareElement: function () {
      return getFormatTypeForBareElement;
    },
    getFormatTypeForClassName: function () {
  ...
  __webpack_require__.d(actions_namespaceObject, {
    addFormatTypes: function () {
      return addFormatTypes;
    },
    removeFormatTypes: function () {
      return removeFormatTypes;
    },
  }); // CONCATENATED MODULE: external ["wp","data"]

  var external_wp_data_namespaceObject = window["wp"]["data"]; // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/store/reducer.js
  /**
    ...
    switch (action.type) {
      ...
      case "REMOVE_FORMAT_TYPES":
        return Object.fromEntries(
          Object.entries(state).filter((_ref) => {
            let [key] = _ref;
  ...
  function getFormatTypeForBareElement(state, bareElementTagName) {
    ...
    return (
      formatTypes.find((_ref) => {
        let { className, tagName } = _ref;
        return className === null && bareElementTagName === tagName;
      }) ||
      formatTypes.find((_ref2) => {
        let { className, tagName } = _ref2;
  ...
  (0, external_wp_data_namespaceObject.register)(store); // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/is-format-equal.js
  ...
  function applyFormat(value, format) {
    ...
    if (startIndex === endIndex) {
      ...
      const startFormat =
        ...
        _newFormats$startInde === void 0
          ? void 0
          : _newFormats$startInde.find((_ref) => {
              let { type } = _ref;
    ...
    return normaliseFormats({
      ...
      activeFormats: [
        ...((activeFormats === null || activeFormats === void 0
          ? void 0
          : activeFormats.filter((_ref3) => {
              let { type } = _ref3;
              return type !== format.type;
            })) || []),
        format,
  ...
  const ZWNBSP = "\ufeff"; // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/create.js
  ...
  function toFormat(_ref) {
    let { tagName, attributes } = _ref;
    let formatType;

    if (attributes && attributes.class) {
      formatType = (0, external_wp_data_namespaceObject.select)(
        store
    ...
    if (!formatType) {
      formatType = (0, external_wp_data_namespaceObject.select)(
        store
      ).getFormatTypeForBareElement(tagName);
    }
    ...
    for (const key in formatType.attributes) {
      ...
      if (formatType.__unstableFilterAttributeValue) {
        registeredAttributes[key] = formatType.__unstableFilterAttributeValue(
          key,
  ...
  function createFromElement(_ref2) {
    ...
    for (let index = 0; index < length; index++) {
      ...
      if (
        isEditableTree && // Ignore any placeholders.
  ...
  function getActiveFormats(_ref) {
    let { formats, start, end, activeFormats } = _ref;
    let EMPTY_ACTIVE_FORMATS =
  ...
  function getActiveFormat(value, formatType) {
    ...
    return (_getActiveFormats = getActiveFormats(value)) === null ||
      _getActiveFormats === void 0
      ? void 0
      : _getActiveFormats.find((_ref) => {
          let { type } = _ref;
  ...
  function getActiveObject(_ref) {
    let { start, end, replacements, text } = _ref;
  ...
  function join(values) {
    ...
    return normaliseFormats(
      values.reduce((accumlator, _ref) => {
        let { formats, replacements, text } = _ref;
        return {
  ...
  function registerFormatType(name, settings) {
    ...
    if (
      (0, external_wp_data_namespaceObject.select)(store).getFormatType(
        settings.name
      )
    ) {
      window.console.error(
    ...
    if (settings.className === null) {
      const formatTypeForBareElement = (0,
      external_wp_data_namespaceObject.select)(
        store
      ...
      const formatTypeForClassName = (0,
      external_wp_data_namespaceObject.select)(store).getFormatTypeForClassName(
        settings.className
      );
    ...
    (0, external_wp_data_namespaceObject.dispatch)(store).addFormatTypes(
      settings
    );
    return settings;
  ...
  function removeFormat(value, formatType) {
    ...
    if (startIndex === endIndex) {
      ...
      if (format) {
        while (
          (_newFormats$startInde2 = newFormats[startIndex]) !== null &&
          _newFormats$startInde2 !== void 0 &&
          _newFormats$startInde2.find((newFormat) => newFormat === format)
        ) {
        ...
        while (
          ...
          _newFormats$endIndex.find((newFormat) => newFormat === format)
        ) {
  ...
  function insert(value, valueToInsert) {
    ...
    return normaliseFormats({
      ...
      text:
        text.slice(0, startIndex) + valueToInsert.text + text.slice(endIndex),
      start: index,
      end: index,
    });
  ...
  function replace_replace(_ref, pattern, replacement) {
    let { formats, replacements, text, start, end } = _ref;
  ...
  function splitAtSelection(_ref2) {
    let { formats, replacements, text, start, end } = _ref2;
    let startIndex =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : start;
    let endIndex =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : end;
    ...
    return [
      ...
      replace_replace(before, /\u2028+$/, ""),
      replace_replace(after, /^\u2028+/, ""),
    ];
  ...
  function get_format_type_getFormatType(name) {
    return (0, external_wp_data_namespaceObject.select)(store).getFormatType(
      name
    );
    ...
    for (let i = 0; i < formatsLength; i++) {
      ...
      if (characterFormats) {
        characterFormats.forEach((format, formatIndex) => {
          if (
            pointer &&
            lastCharacterFormats && // Reuse the last element if all formats remain the same.
      ...
      if (character === OBJECT_REPLACEMENT_CHARACTER) {
        ...
        if (
          !isEditableTree &&
          ((_replacements$i = replacements[i]) === null ||
          _replacements$i === void 0
            ? void 0
            : _replacements$i.type) === "script"
        ) {
          pointer = append(
            getParent(pointer),
            fromFormat({
          ...
          pointer = append(
            getParent(pointer),
            fromFormat({ ...replacements[i], object: true, isEditableTree })
          );
  ...
  function toDom(_ref4) {
    ...
    if (prepareEditableTree) {
      value = { ...value, formats: prepareEditableTree(value) };
    }
    /**
  ...
  var external_wp_escapeHtml_namespaceObject = window["wp"]["escapeHtml"]; // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/to-html-string.js
  /**
   * WordPress dependencies
   */
  ...
  function toHTMLString(_ref) {
    let { value, multilineTag, preserveWhiteSpace } = _ref;
    const tree = toTree({
      value,
      multilineTag,
      preserveWhiteSpace,
  ...
  function createElementHTML(_ref6) {
    let { type, attributes, object, children } = _ref6;
    let attributeString = "";

    for (const key in attributes) {
      if (
        !(0, external_wp_escapeHtml_namespaceObject.isValidAttributeName)(key)
      ) {
        continue;
      }

      attributeString += ` ${key}="${(0,
      external_wp_escapeHtml_namespaceObject.escapeAttribute)(
        attributes[key]
      )}"`;
    }
    ...
    return children
      .map((child) => {
        ...
        return child.text === undefined
          ...
          : (0, external_wp_escapeHtml_namespaceObject.escapeEditableHTML)(
              child.text
            );
      })
      .join("");
  ...
  var external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // CONCATENATED MODULE: external ["wp","i18n"]
  var external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/toggle-format.js
  /**
   * WordPress dependencies
   */
  ...
  function toggleFormat(value, format) {
      ...
      if (format.title) {
        ...
        (0, external_wp_a11y_namespaceObject.speak)(
          (0, external_wp_i18n_namespaceObject.sprintf)(
            (0, external_wp_i18n_namespaceObject.__)("%s removed."),
            format.title
          ),
          "assertive"
        );
    ...
    if (format.title) {
      ...
      (0, external_wp_a11y_namespaceObject.speak)(
        (0, external_wp_i18n_namespaceObject.sprintf)(
          (0, external_wp_i18n_namespaceObject.__)("%s applied."),
          format.title
        ),
        "assertive"
      );
  ...
  function unregisterFormatType(name) {
    const oldFormat = (0, external_wp_data_namespaceObject.select)(
      store
    ).getFormatType(name);
    ...
    (0, external_wp_data_namespaceObject.dispatch)(store).removeFormatTypes(
      name
    );
    return oldFormat;
  } // CONCATENATED MODULE: external ["wp","element"]

  var external_wp_element_namespaceObject = window["wp"]["element"]; // CONCATENATED MODULE: external ["wp","deprecated"]
  ...
  function useAnchor(_ref) {
    let { editableContentElement, value, settings = {} } = _ref;
    const { tagName, className, name } = settings;
    const activeFormat = name ? getActiveFormat(value, name) : undefined;
    return (0, external_wp_element_namespaceObject.useMemo)(() => {
      ...
      const selectionWithinEditableContentElement =
        editableContentElement === null || editableContentElement === void 0
          ? void 0
          : editableContentElement.contains(
  ...
  var external_wp_compose_namespaceObject = window["wp"]["compose"]; // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/component/use-default-style.js
  /**
   * WordPress dependencies
   */
  ...
  function useCopyHandler(props) {
    ...
    return (0, external_wp_compose_namespaceObject.useRefEffect)((element) => {
      function onCopy(event) {
        const { record, multilineTag, preserveWhiteSpace } = propsRef.current;
  ...
  var external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/component/use-format-boundaries.js
  /**
   * WordPress dependencies
   */
  ...
  function useFormatBoundaries(props) {
    ...
    return (0, external_wp_compose_namespaceObject.useRefEffect)((element) => {
      function onKeyDown(event) {
        ...
        const { ownerDocument } = element;
        const { defaultView } = ownerDocument; // To do: ideally, we should look at visual position instead.
        ...
        const newValue = { ...record.current, activeFormats: newActiveFormats };
  ...
  function useSelectObject() {
    return (0, external_wp_compose_namespaceObject.useRefEffect)((element) => {
      function onClick(event) {
        const { target } = event; // If the child element has no text content, it must be an object.
  ...
  function updateFormats(_ref) {
    let { value, start, end, formats } = _ref;
  ...
  function useInputAndSelection(props) {
    ...
    return (0, external_wp_compose_namespaceObject.useRefEffect)((element) => {
      ...
      function onInput(event) {
        ...
        const { start, activeFormats: oldActiveFormats = [] } = record.current; // Update the formats between the last and new caret position.
      ...
      function handleSelectionChange(event) {
        ...
        if (ownerDocument.activeElement !== element) {
          ...
          if (
            ...
            record.current.activeFormats =
              use_input_and_selection_EMPTY_ACTIVE_FORMATS;
      ...
      function onCompositionStart() {
        ...
        )) === null || _element$querySelecto === void 0
          ? void 0
          : _element$querySelecto.remove();
      }
  ...
  function removeLineSeparator(value) {
    ...
    if (collapsed && replacements[index] && replacements[index].length) {
      ...
      newValue = { ...value, replacements: newReplacements };
    } else {
  ...
  function useDelete(props) {
    ...
    return (0, external_wp_compose_namespaceObject.useRefEffect)((element) => {
      function onKeyDown(event) {
        const { keyCode } = event;
        const { createRecord, handleChange, multilineTag } = propsRef.current;
        ...
        if (
          keyCode !== external_wp_keycodes_namespaceObject.DELETE &&
          keyCode !== external_wp_keycodes_namespaceObject.BACKSPACE
        ) {
          return;
        }
        ...
        const isReverse =
          keyCode === external_wp_keycodes_namespaceObject.BACKSPACE; // Always handle full content deletion ourselves.
  ...
  function useRichText(_ref) {
    ...
    const hadSelectionUpdate = (0, external_wp_element_namespaceObject.useRef)(
      false
    );
    ...
    if (!record.current) {
      ...
      const hasRelevantInitFormat =
        ((_record$current = record.current) === null ||
        _record$current === void 0
          ? void 0
          : (_record$current$forma = _record$current.formats[0]) === null ||
            _record$current$forma === void 0
          ? void 0
          : (_record$current$forma2 = _record$current$forma[0]) === null ||
            _record$current$forma2 === void 0
          ? void 0
          : _record$current$forma2.type) === "core/text-color";
    ...
    function handleChange(newRecord) {
      ...
      if (disableFormats) {
        ...
        _value.current = toHTMLString({
          value: __unstableBeforeSerialize
            ? { ...newRecord, formats: __unstableBeforeSerialize(newRecord) }
            : newRecord,
          multilineTag,
          preserveWhiteSpace,
        });
      ...
      const { start, end, formats, text } = newRecord; // Selection must be updated first, so it is recorded in history when
  ...
  function __experimentalRichText() {} // CONCATENATED MODULE: ./node_modules/@wordpress/rich-text/build-module/component/format-edit.js
  ...
  function FormatEdit(_ref) {
    let { formatTypes, onChange, onFocus, value, forwardedRef } = _ref;
    return formatTypes.map((settings) => {
      ...
      return (0, external_wp_element_namespaceObject.createElement)(Edit, {
        ...
        activeObjectAttributes: isObjectActive
