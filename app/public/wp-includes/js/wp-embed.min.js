...
!(function (c, l) {
  ...
  var e = !1,
    o = !1;
  if (l.querySelector) if (c.addEventListener) e = !0;
      ...
      if (!t);
        ...
        for (
          var r,
            s,
            a,
            i = l.querySelectorAll('iframe[data-secret="' + t.secret + '"]'),
    ...
    if (o);
      ...
      for (
        var e,
          ...
          i = l.querySelectorAll("iframe.wp-embedded-content"),
          n = 0;
        n < i.length;
        n++
      ) {
        if (!(r = (t = i[n]).getAttribute("data-secret")))
          (r = Math.random().toString(36).substr(2, 10)),
            (t.src += "#?secret=" + r),
            t.setAttribute("data-secret", r);
        if (s || a)
          (e = t.cloneNode(!0)).removeAttribute("security"),
            t.parentNode.replaceChild(e, t);
        t.contentWindow.postMessage({ message: "ready", secret: r }, "*");
      }
    }
  }
})(window, document);
