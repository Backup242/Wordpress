...
!(function () {
      ...
      9525: function (t) {
        var e = Backbone.Router.extend({
          ...
          showItem: function (t) {
            ...
            o
              ? (o.set("skipHistory", !0), i.trigger("edit:attachment", o))
              : ((o = e.attachment(t)),
      ...
      471: function (t) {
        var e = wp.media.view.Button,
          ...
          o = e.extend({
            ...
            filterChange: function (t) {
              "trash" === t.get("status")
                ? this.model.set("text", i.restoreSelected)
                : wp.media.view.settings.mediaTrash
                ? this.model.set("text", i.trashSelected)
                : this.model.set("text", i.deletePermanently);
            },
        ...
        var e = wp.media.view.Button,
          ...
          o = e.extend({
            ...
            toggleBulkEditHandler: function () {
              ...
              this.controller.isModeActive("select")
                ? (this.model.set({ size: "large", text: i.cancel }),
                  e.not(".spinner, .media-button").hide(),
                  this.$el.show(),
                  t.$el.addClass("media-toolbar-mode-select"),
                  t.$(".delete-selected-button").removeClass("hidden"))
                : (this.model.set({ size: "", text: i.bulkSelect }),
                  this.controller.content.get().$el.removeClass("fixed"),
                  t.$el.css("width", ""),
                  t.$el.removeClass("media-toolbar-mode-select"),
                  t.$(".delete-selected-button").addClass("hidden"),
          ...
          i = i.extend({
            ...
            createModal: function () {
              this.options.modal &&
                ...
                this.modal.on(
                  "close",
                  _.bind(function () {
                    o("body").off("keydown.media-modal"),
                      o(
            ...
            keyEvent: function (t) {
              (("INPUT" !== t.target.nodeName &&
                ...
                t.target.disabled) &&
                (39 === t.keyCode && this.nextMediaItem(), 37 === t.keyCode) &&
            ...
            resetRoute: function () {
              var t = this.controller.browserView.toolbar
                ...
                .$el.val();
              this.gridRouter.navigate(
                this.gridRouter.baseUrl("" !== t ? "?search=" + t : ""),
                { replace: !0 }
              );
            },
          });
          ...
          o = e.extend({
            ...
            bindSearchHandler: function () {
              var t = this.$("#media-search-input"),
                ...
                o = _.throttle(function (t) {
                  ...
                  t &&
                    this.gridRouter.navigate(
                      this.gridRouter.baseUrl((e += "?search=" + t)),
                      { replace: !0 }
                    );
                }, 1e3);
                ...
                this.gridRouter
                  .on("route:search", function () {
                    ...
                    -1 < t.indexOf("mode=")
                      ...
                      : (t +=
                          -1 < t.indexOf("?") ? "&mode=list" : "?mode=list"),
            ...
            fixPosition: function () {
              ...
              this.isModeActive("select") &&
                ((e = (t = this.$(".attachments-browser")).find(
                  ".media-toolbar"
                )),
                t.offset().top + 16 <
  ...
  function s(t) {
    var e = o[t];
    return (
      void 0 !== e || ((e = o[t] = { exports: {} }), i[t](e, e.exports, s)),
      e.exports
    );
  }
  var t;
  ((t = wp.media).controller.EditAttachmentMetadata = s(5817)),
    (t.view.MediaFrame.Manage = s(4817)),
    (t.view.Attachment.Details.TwoColumn = s(7433)),
    (t.view.MediaFrame.Manage.Router = s(9525)),
    (t.view.EditImage.Details = s(9157)),
    (t.view.MediaFrame.EditAttachments = s(5169)),
    (t.view.SelectModeToggleButton = s(6767)),
    (t.view.DeleteSelectedButton = s(471)),
    (t.view.DeleteSelectedPermanentlyButton = s(5562));
})();
