          ...
          announceSearchResults: _.debounce(function () {
            ...
            if (this.collection.mirroring && this.collection.mirroring.args.s) {
              ...
              if (this.collection.hasMore()) {
                wp.a11y.speak(
                  mediaFoundHasMoreResultsMessage.replace("%d", count)
                );
                return;
              }
          ...
          ready: function () {
            ...
            if (this.controller.uploader) {
              ...
              $browser[0].setAttribute(
                ...
                $browser[0].id +
                  " " +
                  $placeholder[0].getAttribute("aria-labelledby")
              );
